# Comparing `tmp/lazylinop-1.0.2-py3-none-any.whl.zip` & `tmp/lazylinop-1.0.3-py3-none-any.whl.zip`
...
## Comparing `lazylinop-1.0.2.dist-info/LICENSE.txt` & `lazylinop-1.0.3.dist-info/LICENSE.txt`

 * *Files identical despite different names*

## Comparing `lazylinop-1.0.2.dist-info/METADATA` & `lazylinop-1.0.3.dist-info/METADATA`
