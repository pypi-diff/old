# Comparing `tmp/libold_poly_porting-0.9.tar.gz` & `tmp/libold_poly_porting-1.3.tar.gz`
...
## Comparing `libold_poly_porting-0.9.tar` & `libold_poly_porting-1.3.tar`
...
### Comparing `libold_poly_porting-0.9/PKG-INFO` & `libold_poly_porting-1.3/PKG-INFO`
...
### Comparing `libold_poly_porting-0.9/libold_poly_porting.egg-info/PKG-INFO` & `libold_poly_porting-1.3/libold_poly_porting.egg-info/PKG-INFO`
...
### Comparing `libold_poly_porting-0.9/poly/__init__.py` & `libold_poly_porting-1.3/poly/__init__.py`
...
### Comparing `libold_poly_porting-0.9/setup.py` & `libold_poly_porting-1.3/setup.py`
