# Comparing `tmp/orwynn-1.0.0b1.tar.gz` & `tmp/orwynn-1.0.0b2.tar.gz`
...
### Comparing `orwynn-1.0.0b1/orwynn/_di/DiContainer.py` & `orwynn-1.0.0b2/orwynn/_di/DiContainer.py`
...
### Comparing `orwynn-1.0.0b1/orwynn/boot/_BootConfig.py` & `orwynn-1.0.0b2/orwynn/boot/_BootConfig.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/boot/boot_test.py` & `orwynn-1.0.0b2/orwynn/boot/boot_test.py`
...
### Comparing `orwynn-1.0.0b1/orwynn/bootscript/_BootscriptWorker.py` & `orwynn-1.0.0b2/orwynn/bootscript/_BootscriptWorker.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/bootscript/bootscript_test.py` & `orwynn-1.0.0b2/orwynn/bootscript/bootscript_test.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/context/_ContextStorage.py` & `orwynn-1.0.0b2/orwynn/context/_ContextStorage.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/context/_context_manager.py` & `orwynn-1.0.0b2/orwynn/context/_context_manager.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/helpers/SUBCLASSABLES.py` & `orwynn-1.0.0b2/orwynn/helpers/SUBCLASSABLES.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/helpers/web.py` & `orwynn-1.0.0b2/orwynn/helpers/web.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/http/_BUILTIN_HTTP_MIDDLEWARE.py` & `orwynn-1.0.0b2/orwynn/http/_BUILTIN_HTTP_MIDDLEWARE.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/http/__init__.py` & `orwynn-1.0.0b2/orwynn/http/__init__.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/http/_context/ContextBuiltinMiddleware.py` & `orwynn-1.0.0b2/orwynn/http/_context/ContextBuiltinMiddleware.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/http/_context/HttpRequestContextBuiltinMiddleware.py` & `orwynn-1.0.0b2/orwynn/http/_context/HttpRequestContextBuiltinMiddleware.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/http/_context/HttpRequestContextId.py` & `orwynn-1.0.0b2/orwynn/http/_context/HttpRequestContextId.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/http/_context/context_test.py` & `orwynn-1.0.0b2/orwynn/http/_context/context_test.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/http/_controller/HttpController.py` & `orwynn-1.0.0b2/orwynn/http/_controller/HttpController.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/http/_controller/endpoint/Endpoint.py` & `orwynn-1.0.0b2/orwynn/http/_controller/endpoint/Endpoint.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/http/_controller/endpoint/EndpointContainer.py` & `orwynn-1.0.0b2/orwynn/http/_controller/endpoint/EndpointContainer.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/http/_controller/endpoint/endpoint_test.py` & `orwynn-1.0.0b2/orwynn/http/_controller/endpoint/endpoint_test.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/http/_controller/http_controller_test.py` & `orwynn-1.0.0b2/orwynn/http/_controller/http_controller_test.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/http/_cors/cors_test.py` & `orwynn-1.0.0b2/orwynn/http/_cors/cors_test.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/http/_errorhandler/ErrorHandlerHttpMiddleware.py` & `orwynn-1.0.0b2/orwynn/http/_errorhandler/ErrorHandlerHttpMiddleware.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/http/_errorhandler/default.py` & `orwynn-1.0.0b2/orwynn/http/_errorhandler/default.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/http/_errorhandler/error_handler_test.py` & `orwynn-1.0.0b2/orwynn/http/_errorhandler/error_handler_test.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/http/_log/HttpLogger.py` & `orwynn-1.0.0b2/orwynn/http/_log/HttpLogger.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/http/_log/LogMiddleware.py` & `orwynn-1.0.0b2/orwynn/http/_log/LogMiddleware.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/http/_middleware/HttpMiddleware.py` & `orwynn-1.0.0b2/orwynn/http/_middleware/HttpMiddleware.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/http/_middleware/http_middleware_test.py` & `orwynn-1.0.0b2/orwynn/http/_middleware/http_middleware_test.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/indication/_Indication.py` & `orwynn-1.0.0b2/orwynn/indication/_Indication.py`
...
### Comparing `orwynn-1.0.0b1/orwynn/log/_LogHandler.py` & `orwynn-1.0.0b2/orwynn/log/_LogHandler.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/log/_configure_log.py` & `orwynn-1.0.0b2/orwynn/log/_configure_log.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/log/log_middleware_test.py` & `orwynn-1.0.0b2/orwynn/log/log_middleware_test.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/log/log_test.py` & `orwynn-1.0.0b2/orwynn/log/log_test.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/log/log_websocket_middleware_test.py` & `orwynn-1.0.0b2/orwynn/log/log_websocket_middleware_test.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/mapping/_Mapping.py` & `orwynn-1.0.0b2/orwynn/mapping/_Mapping.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/mongo/_Document.py` & `orwynn-1.0.0b2/orwynn/mongo/_Document.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/mongo/_Mongo.py` & `orwynn-1.0.0b2/orwynn/mongo/_Mongo.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/mongo/document_test.py` & `orwynn-1.0.0b2/orwynn/mongo/document_test.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/mongo/mongo_test.py` & `orwynn-1.0.0b2/orwynn/mongo/mongo_test.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/proxy/BootProxy.py` & `orwynn-1.0.0b2/orwynn/proxy/BootProxy.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/router/_ControllerRegister.py` & `orwynn-1.0.0b2/orwynn/router/_ControllerRegister.py`
...
### Comparing `orwynn-1.0.0b1/orwynn/router/_ErrorHandlerManager.py` & `orwynn-1.0.0b2/orwynn/router/_ErrorHandlerManager.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/router/_MiddlewareRegister.py` & `orwynn-1.0.0b2/orwynn/router/_MiddlewareRegister.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/router/_Router.py` & `orwynn-1.0.0b2/orwynn/router/_Router.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/router/global_http_route_test.py` & `orwynn-1.0.0b2/orwynn/router/global_http_route_test.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/singleton/_Singleton.py` & `orwynn-1.0.0b2/orwynn/singleton/_Singleton.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/sql/_Sql.py` & `orwynn-1.0.0b2/orwynn/sql/_Sql.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/sql/_SqlConfig.py` & `orwynn-1.0.0b2/orwynn/sql/_SqlConfig.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/sql/_Table.py` & `orwynn-1.0.0b2/orwynn/sql/_Table.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/sql/sql_test.py` & `orwynn-1.0.0b2/orwynn/sql/sql_test.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/testing/_Client.py` & `orwynn-1.0.0b2/orwynn/testing/_Client.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/testing/__init__.py` & `orwynn-1.0.0b2/orwynn/testing/__init__.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/testing/client_test.py` & `orwynn-1.0.0b2/orwynn/testing/client_test.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/utils/crypto/__init__.py` & `orwynn-1.0.0b2/orwynn/utils/crypto/__init__.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/utils/fmt/__init__.py` & `orwynn-1.0.0b2/orwynn/utils/fmt/__init__.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/utils/fmt/fmt_test.py` & `orwynn-1.0.0b2/orwynn/utils/fmt/fmt_test.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/utils/mp/__init__.py` & `orwynn-1.0.0b2/orwynn/utils/mp/__init__.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/utils/mp/location.py` & `orwynn-1.0.0b2/orwynn/utils/mp/location.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/utils/mp/mp_test.py` & `orwynn-1.0.0b2/orwynn/utils/mp/mp_test.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/utils/ucls/__init__.py` & `orwynn-1.0.0b2/orwynn/utils/klass/__init__.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/utils/ucls/cls_test.py` & `orwynn-1.0.0b2/orwynn/utils/klass/klass_test.py`
...
-from orwynn.utils.ucls import bind_first_arg, bind_first_arg_async
...
### Comparing `orwynn-1.0.0b1/orwynn/utils/url/__init__.py` & `orwynn-1.0.0b2/orwynn/utils/url/__init__.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/utils/url/_get_vars.py` & `orwynn-1.0.0b2/orwynn/utils/url/_get_vars.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/utils/url/get_vars_test.py` & `orwynn-1.0.0b2/orwynn/utils/url/get_vars_test.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/utils/validation/__init__.py` & `orwynn-1.0.0b2/orwynn/utils/validation/__init__.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/utils/validation/errors.py` & `orwynn-1.0.0b2/orwynn/utils/validation/errors.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/utils/yml/__init__.py` & `orwynn-1.0.0b2/orwynn/utils/yml/__init__.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/websocket/_BUILTIN_WEBSOCKET_MIDDLEWARE.py` & `orwynn-1.0.0b2/orwynn/websocket/_BUILTIN_WEBSOCKET_MIDDLEWARE.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/websocket/__init__.py` & `orwynn-1.0.0b2/orwynn/websocket/__init__.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/websocket/_context/ContextBuiltinWebsocketMiddleware.py` & `orwynn-1.0.0b2/orwynn/websocket/_context/ContextBuiltinWebsocketMiddleware.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/websocket/_context/RequestContextBuiltinWebsocketMiddleware.py` & `orwynn-1.0.0b2/orwynn/websocket/_context/RequestContextBuiltinWebsocketMiddleware.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/websocket/_context/WebsocketRequestContextId.py` & `orwynn-1.0.0b2/orwynn/websocket/_context/WebsocketRequestContextId.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/websocket/_context/websocket_context_test.py` & `orwynn-1.0.0b2/orwynn/websocket/_context/websocket_context_test.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/websocket/_controller/WebsocketController.py` & `orwynn-1.0.0b2/orwynn/websocket/_controller/WebsocketController.py`
...
### Comparing `orwynn-1.0.0b1/orwynn/websocket/_controller/global_websocket_route_test.py` & `orwynn-1.0.0b2/orwynn/websocket/_controller/global_websocket_route_test.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/websocket/_controller/websocket_controller_test.py` & `orwynn-1.0.0b2/orwynn/websocket/_controller/websocket_controller_test.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/websocket/_errorhandler/ErrorHandlerWebsocketMiddleware.py` & `orwynn-1.0.0b2/orwynn/websocket/_errorhandler/ErrorHandlerWebsocketMiddleware.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/websocket/_errorhandler/error_handler_websocket_test.py` & `orwynn-1.0.0b2/orwynn/websocket/_errorhandler/error_handler_websocket_test.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/websocket/_log/LogWebsocketMiddleware.py` & `orwynn-1.0.0b2/orwynn/websocket/_log/LogWebsocketMiddleware.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/websocket/_log/WebsocketLogger.py` & `orwynn-1.0.0b2/orwynn/websocket/_log/WebsocketLogger.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/websocket/_middleware/ConnectionBuiltinWebsocketMiddleware.py` & `orwynn-1.0.0b2/orwynn/websocket/_middleware/ConnectionBuiltinWebsocketMiddleware.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/websocket/_middleware/WebsocketMiddleware.py` & `orwynn-1.0.0b2/orwynn/websocket/_middleware/WebsocketMiddleware.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/websocket/_middleware/websocket_middleware_test.py` & `orwynn-1.0.0b2/orwynn/websocket/_middleware/websocket_middleware_test.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/websocket/_routing/NextCallHandler.py` & `orwynn-1.0.0b2/orwynn/websocket/_routing/NextCallHandler.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/websocket/_routing/WebsocketStack.py` & `orwynn-1.0.0b2/orwynn/websocket/_routing/WebsocketStack.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/orwynn/websocket/_routing/_get_handler_kwargs.py` & `orwynn-1.0.0b2/orwynn/websocket/_routing/_get_handler_kwargs.py`

 * *Files identical despite different names*

### Comparing `orwynn-1.0.0b1/pyproject.toml` & `orwynn-1.0.0b2/pyproject.toml`
...
### Comparing `orwynn-1.0.0b1/setup.py` & `orwynn-1.0.0b2/setup.py`
...
### Comparing `orwynn-1.0.0b1/PKG-INFO` & `orwynn-1.0.0b2/PKG-INFO`
