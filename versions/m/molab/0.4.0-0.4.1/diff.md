# Comparing `tmp/molab-0.4.0.tar.gz` & `tmp/molab-0.4.1.tar.gz`
...
### Comparing `molab-0.4.0/molab/template_files/install_class_config.json` & `molab-0.4.1/molab/template_files/install_class_config.json`
