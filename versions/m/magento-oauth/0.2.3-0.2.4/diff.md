# Comparing `tmp/magento_oauth-0.2.3.tar.gz` & `tmp/magento_oauth-0.2.4.tar.gz`
...
## Comparing `magento_oauth-0.2.3.tar` & `magento_oauth-0.2.4.tar`
...
### Comparing `magento_oauth-0.2.3/PKG-INFO` & `magento_oauth-0.2.4/PKG-INFO`
...
### Comparing `magento_oauth-0.2.3/setup.py` & `magento_oauth-0.2.4/setup.py`
...
### Comparing `magento_oauth-0.2.3/src/magento_oauth.egg-info/PKG-INFO` & `magento_oauth-0.2.4/src/magento_oauth.egg-info/PKG-INFO`
...
### Comparing `magento_oauth-0.2.3/src/oauth_magento/oauth_magento_openedx.py` & `magento_oauth-0.2.4/src/oauth_magento/oauth_magento_openedx.py`
