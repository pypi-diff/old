# Comparing `tmp/mq-misc-0.0.1.tar.gz` & `tmp/mq-misc-0.0.2.tar.gz`
...
## Comparing `mq-misc-0.0.1.tar` & `mq-misc-0.0.2.tar`
...
### Comparing `mq-misc-0.0.1/PKG-INFO` & `mq-misc-0.0.2/PKG-INFO`
...
### Comparing `mq-misc-0.0.1/README.md` & `mq-misc-0.0.2/README.md`

 * *Files identical despite different names*

### Comparing `mq-misc-0.0.1/mq_misc/amqp.py` & `mq-misc-0.0.2/mq_misc/amqp.py`
...
### Comparing `mq-misc-0.0.1/mq_misc/publish/__main__.py` & `mq-misc-0.0.2/mq_misc/publish/__main__.py`

 * *Files identical despite different names*

### Comparing `mq-misc-0.0.1/mq_misc.egg-info/PKG-INFO` & `mq-misc-0.0.2/mq_misc.egg-info/PKG-INFO`
...
### Comparing `mq-misc-0.0.1/setup.py` & `mq-misc-0.0.2/setup.py`
