# Comparing `tmp/mypyllant-0.1.5.tar.gz` & `tmp/mypyllant-0.1.6.tar.gz`
...
### Comparing `mypyllant-0.1.5/src/myPyllant/sample.py` & `mypyllant-0.1.6/src/myPyllant/sample.py`
