# Comparing `tmp/macrometa-target-collection-0.0.44.tar.gz` & `tmp/macrometa-target-collection-0.0.45.tar.gz`
...
## Comparing `macrometa-target-collection-0.0.44.tar` & `macrometa-target-collection-0.0.45.tar`
...
### Comparing `macrometa-target-collection-0.0.44/LICENSE` & `macrometa-target-collection-0.0.45/LICENSE`

 * *Files identical despite different names*

### Comparing `macrometa-target-collection-0.0.44/PKG-INFO` & `macrometa-target-collection-0.0.45/PKG-INFO`
...
### Comparing `macrometa-target-collection-0.0.44/macrometa_target_collection/__init__.py` & `macrometa-target-collection-0.0.45/macrometa_target_collection/__init__.py`

 * *Files identical despite different names*

### Comparing `macrometa-target-collection-0.0.44/macrometa_target_collection/main.py` & `macrometa-target-collection-0.0.45/macrometa_target_collection/main.py`
...
### Comparing `macrometa-target-collection-0.0.44/macrometa_target_collection.egg-info/PKG-INFO` & `macrometa-target-collection-0.0.45/macrometa_target_collection.egg-info/PKG-INFO`
...
### Comparing `macrometa-target-collection-0.0.44/pyproject.toml` & `macrometa-target-collection-0.0.45/pyproject.toml`
