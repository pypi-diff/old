# Comparing `tmp/master_dac-2023.4.6.tar.gz` & `tmp/master_dac-2023.4.6.post2.tar.gz`
...
## Comparing `master_dac-2023.4.6.tar` & `master_dac-2023.4.6.post2.tar`
...
### Comparing `master_dac-2023.4.6/master_dac/__main__.py` & `master_dac-2023.4.6.post2/master_dac/__main__.py`

 * *Files identical despite different names*

### Comparing `master_dac-2023.4.6/master_dac/configuration.py` & `master_dac-2023.4.6.post2/master_dac/configuration.py`

 * *Files identical despite different names*

### Comparing `master_dac-2023.4.6/master_dac/datasets.py` & `master_dac-2023.4.6.post2/master_dac/datasets.py`
...
### Comparing `master_dac-2023.4.6/master_dac/install.py` & `master_dac-2023.4.6.post2/master_dac/install.py`

 * *Files identical despite different names*

### Comparing `master_dac-2023.4.6/master_dac/utils.py` & `master_dac-2023.4.6.post2/master_dac/utils.py`

 * *Files identical despite different names*

### Comparing `master_dac-2023.4.6/master_dac.egg-info/SOURCES.txt` & `master_dac-2023.4.6.post2/master_dac.egg-info/SOURCES.txt`
