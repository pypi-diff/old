# Comparing `tmp/mongo_to_som-1.0.2.tar.gz` & `tmp/mongo_to_som-1.0.3.tar.gz`
...
## Comparing `mongo_to_som-1.0.2.tar` & `mongo_to_som-1.0.3.tar`
...
### Comparing `mongo_to_som-1.0.2/PKG-INFO` & `mongo_to_som-1.0.3/PKG-INFO`
...
### Comparing `mongo_to_som-1.0.2/mongo_to_som/mongotosom.py` & `mongo_to_som-1.0.3/mongo_to_som/mongotosom.py`

 * *Files identical despite different names*

### Comparing `mongo_to_som-1.0.2/mongo_to_som.egg-info/PKG-INFO` & `mongo_to_som-1.0.3/mongo_to_som.egg-info/PKG-INFO`
...
### Comparing `mongo_to_som-1.0.2/setup.py` & `mongo_to_som-1.0.3/setup.py`
