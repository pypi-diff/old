# Comparing `tmp/mmengine-0.7.1.tar.gz` & `tmp/mmengine-0.7.2.tar.gz`
...
### Comparing `mmengine-0.7.1/README.md` & `mmengine-0.7.2/README.md`
...
### Comparing `mmengine-0.7.1/mmengine/dataset/sampler.py` & `mmengine-0.7.2/mmengine/dataset/sampler.py`
...
### Comparing `mmengine-0.7.1/mmengine/fileio/handlers/json_handler.py` & `mmengine-0.7.2/mmengine/fileio/handlers/json_handler.py`
...
### Comparing `mmengine-0.7.1/mmengine/hooks/early_stopping_hook.py` & `mmengine-0.7.2/mmengine/hooks/early_stopping_hook.py`
...
### Comparing `mmengine-0.7.1/mmengine/hooks/sampler_seed_hook.py` & `mmengine-0.7.2/mmengine/hooks/sampler_seed_hook.py`
...
### Comparing `mmengine-0.7.1/mmengine/model/test_time_aug.py` & `mmengine-0.7.2/mmengine/model/test_time_aug.py`
...
### Comparing `mmengine-0.7.1/mmengine/utils/manager.py` & `mmengine-0.7.2/mmengine/utils/manager.py`
...
### Comparing `mmengine-0.7.1/mmengine/utils/progressbar.py` & `mmengine-0.7.2/mmengine/utils/progressbar.py`

 * *Files identical despite different names*

### Comparing `mmengine-0.7.1/mmengine/utils/timer.py` & `mmengine-0.7.2/mmengine/utils/timer.py`

 * *Files identical despite different names*

### Comparing `mmengine-0.7.1/mmengine/utils/version_utils.py` & `mmengine-0.7.2/mmengine/utils/version_utils.py`

 * *Files identical despite different names*

### Comparing `mmengine-0.7.1/mmengine/version.py` & `mmengine-0.7.2/mmengine/version.py`
...
### Comparing `mmengine-0.7.1/mmengine/visualization/utils.py` & `mmengine-0.7.2/mmengine/visualization/utils.py`

 * *Files identical despite different names*

### Comparing `mmengine-0.7.1/mmengine/visualization/vis_backend.py` & `mmengine-0.7.2/mmengine/visualization/vis_backend.py`

 * *Files identical despite different names*

### Comparing `mmengine-0.7.1/mmengine/visualization/visualizer.py` & `mmengine-0.7.2/mmengine/visualization/visualizer.py`

 * *Files identical despite different names*

### Comparing `mmengine-0.7.1/mmengine.egg-info/PKG-INFO` & `mmengine-0.7.2/mmengine.egg-info/PKG-INFO`
...
### Comparing `mmengine-0.7.1/mmengine.egg-info/SOURCES.txt` & `mmengine-0.7.2/mmengine.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `mmengine-0.7.1/setup.py` & `mmengine-0.7.2/setup.py`
