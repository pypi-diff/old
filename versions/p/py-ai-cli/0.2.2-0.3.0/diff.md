# Comparing `tmp/py-ai-cli-0.2.2.tar.gz` & `tmp/py-ai-cli-0.3.0.tar.gz`
...
## Comparing `py-ai-cli-0.2.2.tar` & `py-ai-cli-0.3.0.tar`
...
### Comparing `py-ai-cli-0.2.2/CHANGELOG.md` & `py-ai-cli-0.3.0/CHANGELOG.md`
...
### Comparing `py-ai-cli-0.2.2/README.md` & `py-ai-cli-0.3.0/README.md`

 * *Files identical despite different names*

### Comparing `py-ai-cli-0.2.2/README_ja.md` & `py-ai-cli-0.3.0/README_ja.md`

 * *Files identical despite different names*

### Comparing `py-ai-cli-0.2.2/README_zh.md` & `py-ai-cli-0.3.0/README_zh.md`

 * *Files identical despite different names*

### Comparing `py-ai-cli-0.2.2/pyproject.toml` & `py-ai-cli-0.3.0/pyproject.toml`
...
### Comparing `py-ai-cli-0.2.2/src/ai_cli/__init__.py` & `py-ai-cli-0.3.0/src/ai_cli/__init__.py`
...
### Comparing `py-ai-cli-0.2.2/src/ai_cli/bot/__init__.py` & `py-ai-cli-0.3.0/src/ai_cli/bot/__init__.py`
...
### Comparing `py-ai-cli-0.2.2/src/ai_cli/cli.py` & `py-ai-cli-0.3.0/src/ai_cli/cli.py`

 * *Files identical despite different names*

### Comparing `py-ai-cli-0.2.2/src/ai_cli/git.py` & `py-ai-cli-0.3.0/src/ai_cli/git.py`

 * *Files identical despite different names*

### Comparing `py-ai-cli-0.2.2/src/ai_cli/setting.py` & `py-ai-cli-0.3.0/src/ai_cli/setting.py`
...
### Comparing `py-ai-cli-0.2.2/PKG-INFO` & `py-ai-cli-0.3.0/PKG-INFO`
