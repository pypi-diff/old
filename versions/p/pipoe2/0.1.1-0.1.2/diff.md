# Comparing `tmp/pipoe2-0.1.1.tar.gz` & `tmp/pipoe2-0.1.2.tar.gz`
...
## Comparing `pipoe2-0.1.1.tar` & `pipoe2-0.1.2.tar`
...
### Comparing `pipoe2-0.1.1/pipoe2/__main__.py` & `pipoe2-0.1.2/pipoe2/__main__.py`
