# Comparing `tmp/propan-0.0.8.6.tar.gz` & `tmp/propan-0.0.8.7.tar.gz`

## Comparing `propan-0.0.8.6.tar` & `propan-0.0.8.7.tar`
...
### Comparing `propan-0.0.8.6/CONTRIBUTING.md` & `propan-0.0.8.7/CONTRIBUTING.md`

 * *Files identical despite different names*

### Comparing `propan-0.0.8.6/examples/3_lifespan_events.py` & `propan-0.0.8.7/examples/3_lifespan_events.py`
...
### Comparing `propan-0.0.8.6/examples/4_cli_attributes_promotion.py` & `propan-0.0.8.7/examples/4_cli_attributes_promotion.py`
...
### Comparing `propan-0.0.8.6/examples/5_publishing.py` & `propan-0.0.8.7/examples/5_publishing.py`
...
### Comparing `propan-0.0.8.6/examples/6_arguments_casting.py` & `propan-0.0.8.7/examples/6_arguments_casting.py`
...
### Comparing `propan-0.0.8.6/examples/7_handler_errors_processing.py` & `propan-0.0.8.7/examples/7_handler_errors_processing.py`
...
### Comparing `propan-0.0.8.6/examples/dependencies/1_dependency_injection.py` & `propan-0.0.8.7/examples/dependencies/1_dependency_injection.py`
...
### Comparing `propan-0.0.8.6/examples/dependencies/2_dependency_declaration.py` & `propan-0.0.8.7/examples/dependencies/2_dependency_declaration.py`
...
### Comparing `propan-0.0.8.6/examples/dependencies/4_dependency_deep_aliases.py` & `propan-0.0.8.7/examples/dependencies/4_dependency_deep_aliases.py`
...
### Comparing `propan-0.0.8.6/examples/dependencies/5_dependency_nesting.py` & `propan-0.0.8.7/examples/dependencies/5_dependency_nesting.py`
...
### Comparing `propan-0.0.8.6/examples/dependencies/6_dependecy_calling.py` & `propan-0.0.8.7/examples/dependencies/6_dependecy_calling.py`
...
### Comparing `propan-0.0.8.6/examples/http_frameworks_integrations/aiohttp.py` & `propan-0.0.8.7/examples/http_frameworks_integrations/aiohttp.py`
...
### Comparing `propan-0.0.8.6/examples/http_frameworks_integrations/blacksheep.py` & `propan-0.0.8.7/examples/http_frameworks_integrations/blacksheep.py`
...
### Comparing `propan-0.0.8.6/examples/http_frameworks_integrations/falcon.py` & `propan-0.0.8.7/examples/http_frameworks_integrations/falcon.py`
...
### Comparing `propan-0.0.8.6/examples/http_frameworks_integrations/fastapi.py` & `propan-0.0.8.7/examples/http_frameworks_integrations/fastapi.py`
...
### Comparing `propan-0.0.8.6/examples/http_frameworks_integrations/quart.py` & `propan-0.0.8.7/examples/http_frameworks_integrations/sanic.py`
...
### Comparing `propan-0.0.8.6/examples/http_frameworks_integrations/sanic.py` & `propan-0.0.8.7/examples/http_frameworks_integrations/quart.py`
...
### Comparing `propan-0.0.8.6/examples/http_frameworks_integrations/tornado.py` & `propan-0.0.8.7/examples/http_frameworks_integrations/tornado.py`
...
### Comparing `propan-0.0.8.6/propan/app.py` & `propan-0.0.8.7/propan/cli/app.py`
...
### Comparing `propan-0.0.8.6/propan/brokers/push_back_watcher.py` & `propan-0.0.8.7/propan/brokers/push_back_watcher.py`
...
### Comparing `propan-0.0.8.6/propan/brokers/model/broker_usecase.py` & `propan-0.0.8.7/propan/brokers/model/broker_usecase.py`
...
### Comparing `propan-0.0.8.6/propan/brokers/nats/nats_broker.py` & `propan-0.0.8.7/propan/brokers/nats/nats_broker.py`
...
### Comparing `propan-0.0.8.6/propan/brokers/nats/nats_broker.pyi` & `propan-0.0.8.7/propan/brokers/nats/nats_broker.pyi`
...
### Comparing `propan-0.0.8.6/propan/brokers/nats/nats_js_broker.py` & `propan-0.0.8.7/propan/brokers/nats/nats_js_broker.py`
...
### Comparing `propan-0.0.8.6/propan/brokers/rabbit/rabbit_broker.py` & `propan-0.0.8.7/propan/brokers/rabbit/rabbit_broker.py`
...
### Comparing `propan-0.0.8.6/propan/brokers/rabbit/rabbit_broker.pyi` & `propan-0.0.8.7/propan/brokers/rabbit/rabbit_broker.pyi`
...
### Comparing `propan-0.0.8.6/propan/brokers/rabbit/schemas.py` & `propan-0.0.8.7/propan/brokers/rabbit/schemas.py`
...
### Comparing `propan-0.0.8.6/propan/cli/main.py` & `propan-0.0.8.7/propan/cli/main.py`
...
### Comparing `propan-0.0.8.6/propan/cli/startproject.py` & `propan-0.0.8.7/propan/cli/startproject.py`
...
### Comparing `propan-0.0.8.6/propan/cli/supervisors/multiprocess.py` & `propan-0.0.8.7/propan/cli/supervisors/multiprocess.py`
...
### Comparing `propan-0.0.8.6/propan/cli/supervisors/utils.py` & `propan-0.0.8.7/propan/cli/supervisors/utils.py`
...
### Comparing `propan-0.0.8.6/propan/cli/supervisors/watchgodreloader.py` & `propan-0.0.8.7/propan/cli/supervisors/watchgodreloader.py`
...
### Comparing `propan-0.0.8.6/propan/log/formatter.py` & `propan-0.0.8.7/propan/log/formatter.py`
...
### Comparing `propan-0.0.8.6/propan/log/logging.py` & `propan-0.0.8.7/propan/log/logging.py`
...
### Comparing `propan-0.0.8.6/propan/utils/context/decorate.py` & `propan-0.0.8.7/propan/utils/context/decorate.py`
...
### Comparing `propan-0.0.8.6/propan/utils/context/main.py` & `propan-0.0.8.7/propan/utils/context/main.py`
...
### Comparing `propan-0.0.8.6/propan/utils/types/decorate.py` & `propan-0.0.8.7/propan/utils/types/decorate.py`
...
### Comparing `propan-0.0.8.6/LICENSE` & `propan-0.0.8.7/LICENSE`

 * *Files identical despite different names*

### Comparing `propan-0.0.8.6/README.md` & `propan-0.0.8.7/README.md`
...
### Comparing `propan-0.0.8.6/pyproject.toml` & `propan-0.0.8.7/pyproject.toml`
...
### Comparing `propan-0.0.8.6/PKG-INFO` & `propan-0.0.8.7/PKG-INFO`
