# Comparing `tmp/plone.app.multilingual-6.0.2.tar.gz` & `tmp/plone.app.multilingual-7.0.0.tar.gz`
...
### Comparing `plone.app.multilingual-6.0.2/README.rst` & `plone.app.multilingual-7.0.0/README.rst`
...
### Comparing `plone.app.multilingual-6.0.2/src/plone/app/multilingual/browser/modify.py` & `plone.app.multilingual-7.0.0/src/plone/app/multilingual/browser/modify.py`
...
### Comparing `plone.app.multilingual-6.0.2/src/plone/app/multilingual/browser/vocabularies.py` & `plone.app.multilingual-7.0.0/src/plone/app/multilingual/browser/vocabularies.py`
...
### Comparing `plone.app.multilingual-6.0.2/src/plone/app/multilingual/tests/test_form.py` & `plone.app.multilingual-7.0.0/src/plone/app/multilingual/tests/test_form.py`

 * *Files identical despite different names*

### Comparing `plone.app.multilingual-6.0.2/src/plone/app/multilingual/tests/test_helper_views.py` & `plone.app.multilingual-7.0.0/src/plone/app/multilingual/tests/test_helper_views.py`

 * *Files identical despite different names*

### Comparing `plone.app.multilingual-6.0.2/src/plone/app/multilingual/tests/test_lif.py` & `plone.app.multilingual-7.0.0/src/plone/app/multilingual/tests/test_lif.py`

 * *Files identical despite different names*

### Comparing `plone.app.multilingual-6.0.2/src/plone/app/multilingual/tests/test_lrf.py` & `plone.app.multilingual-7.0.0/src/plone/app/multilingual/tests/test_lrf.py`

 * *Files identical despite different names*

### Comparing `plone.app.multilingual-6.0.2/src/plone/app/multilingual/tests/test_menu.py` & `plone.app.multilingual-7.0.0/src/plone/app/multilingual/tests/test_menu.py`

 * *Files identical despite different names*

### Comparing `plone.app.multilingual-6.0.2/src/plone/app/multilingual/tests/test_robot.py` & `plone.app.multilingual-7.0.0/src/plone/app/multilingual/tests/test_robot.py`

 * *Files identical despite different names*

### Comparing `plone.app.multilingual-6.0.2/src/plone/app/multilingual/tests/test_selector.py` & `plone.app.multilingual-7.0.0/src/plone/app/multilingual/tests/test_selector.py`

 * *Files identical despite different names*

### Comparing `plone.app.multilingual-6.0.2/src/plone/app/multilingual/tests/test_setup.py` & `plone.app.multilingual-7.0.0/src/plone/app/multilingual/tests/test_setup.py`

 * *Files identical despite different names*

### Comparing `plone.app.multilingual-6.0.2/src/plone/app/multilingual/tests/test_sitemap.py` & `plone.app.multilingual-7.0.0/src/plone/app/multilingual/tests/test_sitemap.py`

 * *Files identical despite different names*

### Comparing `plone.app.multilingual-6.0.2/src/plone/app/multilingual/tests/test_subscribers.py` & `plone.app.multilingual-7.0.0/src/plone/app/multilingual/tests/test_subscribers.py`

 * *Files identical despite different names*

### Comparing `plone.app.multilingual-6.0.2/src/plone/app/multilingual/tests/test_uninstall.py` & `plone.app.multilingual-7.0.0/src/plone/app/multilingual/tests/test_uninstall.py`

 * *Files identical despite different names*

### Comparing `plone.app.multilingual-6.0.2/src/plone/app/multilingual/tests/test_vocabularies.py` & `plone.app.multilingual-7.0.0/src/plone/app/multilingual/tests/test_vocabularies.py`

 * *Files identical despite different names*

### Comparing `plone.app.multilingual-6.0.2/src/plone/app/multilingual/upgrades.py` & `plone.app.multilingual-7.0.0/src/plone/app/multilingual/upgrades.py`

 * *Files identical despite different names*

### Comparing `plone.app.multilingual-6.0.2/src/plone/app/multilingual/upgrades.zcml` & `plone.app.multilingual-7.0.0/src/plone/app/multilingual/upgrades.zcml`

 * *Files identical despite different names*

### Comparing `plone.app.multilingual-6.0.2/src/plone.app.multilingual.egg-info/PKG-INFO` & `plone.app.multilingual-7.0.0/src/plone.app.multilingual.egg-info/PKG-INFO`
...
### Comparing `plone.app.multilingual-6.0.2/src/plone.app.multilingual.egg-info/SOURCES.txt` & `plone.app.multilingual-7.0.0/src/plone.app.multilingual.egg-info/SOURCES.txt`

 * *Files 0% similar despite different names*

```diff
@@ -93,14 +93,15 @@
 src/plone/app/multilingual/dx/__init__.py
 src/plone/app/multilingual/dx/cloner.py
 src/plone/app/multilingual/dx/configure.zcml
 src/plone/app/multilingual/dx/directives.py
 src/plone/app/multilingual/dx/form.py
 src/plone/app/multilingual/dx/interfaces.py
 src/plone/app/multilingual/dx/language.py
+src/plone/app/multilingual/dx/languageindependent.py
 src/plone/app/multilingual/dx/meta.zcml
 src/plone/app/multilingual/dx/schemaeditor.py
 src/plone/app/multilingual/dx/subscriber.py
 src/plone/app/multilingual/dx/supermodel.py
 src/plone/app/multilingual/profiles/default/browserlayer.xml
 src/plone/app/multilingual/profiles/default/catalog.xml
 src/plone/app/multilingual/profiles/default/metadata.xml
```
