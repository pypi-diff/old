# Comparing `tmp/pandas_dq-1.2.tar.gz` & `tmp/pandas_dq-1.3.tar.gz`
...
## Comparing `pandas_dq-1.2.tar` & `pandas_dq-1.3.tar`
...
### Comparing `pandas_dq-1.2/LICENSE` & `pandas_dq-1.3/LICENSE`

 * *Files identical despite different names*

### Comparing `pandas_dq-1.2/MANIFEST.in` & `pandas_dq-1.3/MANIFEST.in`

 * *Files identical despite different names*

### Comparing `pandas_dq-1.2/PKG-INFO` & `pandas_dq-1.3/pandas_dq.egg-info/PKG-INFO`
...
### Comparing `pandas_dq-1.2/README.md` & `pandas_dq-1.3/README.md`
...
### Comparing `pandas_dq-1.2/pandas_dq.egg-info/PKG-INFO` & `pandas_dq-1.3/PKG-INFO`
...
### Comparing `pandas_dq-1.2/setup.py` & `pandas_dq-1.3/setup.py`
