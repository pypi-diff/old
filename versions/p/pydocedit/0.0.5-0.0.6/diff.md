# Comparing `tmp/pydocedit-0.0.5.tar.gz` & `tmp/pydocedit-0.0.6.tar.gz`
...
## Comparing `pydocedit-0.0.5.tar` & `pydocedit-0.0.6.tar`
...
### Comparing `pydocedit-0.0.5/LICENSE` & `pydocedit-0.0.6/LICENSE`

 * *Files identical despite different names*

### Comparing `pydocedit-0.0.5/PKG-INFO` & `pydocedit-0.0.6/PKG-INFO`
...
### Comparing `pydocedit-0.0.5/setup.py` & `pydocedit-0.0.6/setup.py`
...
### Comparing `pydocedit-0.0.5/src/pydocedit.egg-info/PKG-INFO` & `pydocedit-0.0.6/src/pydocedit.egg-info/PKG-INFO`
...
### Comparing `pydocedit-0.0.5/src/pydocedit.py` & `pydocedit-0.0.6/src/pydocedit.py`
