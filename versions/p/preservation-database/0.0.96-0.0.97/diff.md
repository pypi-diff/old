# Comparing `tmp/preservation-database-0.0.96.tar.gz` & `tmp/preservation-database-0.0.97.tar.gz`
...
### Comparing `preservation-database-0.0.96/setup.cfg` & `preservation-database-0.0.97/setup.cfg`
