# Comparing `tmp/quantrocket-moonchart-2.8.0.0.tar.gz` & `tmp/quantrocket-moonchart-2.9.0.2.tar.gz`
...
## Comparing `quantrocket-moonchart-2.8.0.0.tar` & `quantrocket-moonchart-2.9.0.2.tar`
...
### Comparing `quantrocket-moonchart-2.8.0.0/LICENSE.txt` & `quantrocket-moonchart-2.9.0.2/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `quantrocket-moonchart-2.8.0.0/README.md` & `quantrocket-moonchart-2.9.0.2/README.md`

 * *Files identical despite different names*

### Comparing `quantrocket-moonchart-2.8.0.0/moonchart/base.py` & `quantrocket-moonchart-2.9.0.2/moonchart/base.py`
...
### Comparing `quantrocket-moonchart-2.8.0.0/moonchart/exceptions.py` & `quantrocket-moonchart-2.9.0.2/moonchart/exceptions.py`
...
### Comparing `quantrocket-moonchart-2.8.0.0/moonchart/paramscan.py` & `quantrocket-moonchart-2.9.0.2/moonchart/paramscan.py`
...
### Comparing `quantrocket-moonchart-2.8.0.0/moonchart/perf.py` & `quantrocket-moonchart-2.9.0.2/moonchart/perf.py`
...
### Comparing `quantrocket-moonchart-2.8.0.0/moonchart/shortfall.py` & `quantrocket-moonchart-2.9.0.2/moonchart/shortfall.py`
...
### Comparing `quantrocket-moonchart-2.8.0.0/moonchart/tearsheet.py` & `quantrocket-moonchart-2.9.0.2/moonchart/tearsheet.py`
...
### Comparing `quantrocket-moonchart-2.8.0.0/moonchart/tests/test_perf.py` & `quantrocket-moonchart-2.9.0.2/moonchart/_tests/test_perf.py`
...
### Comparing `quantrocket-moonchart-2.8.0.0/moonchart/tests/test_utils.py` & `quantrocket-moonchart-2.9.0.2/moonchart/_tests/test_utils.py`
...
### Comparing `quantrocket-moonchart-2.8.0.0/moonchart/utils.py` & `quantrocket-moonchart-2.9.0.2/moonchart/utils.py`
...
### Comparing `quantrocket-moonchart-2.8.0.0/quantrocket_moonchart.egg-info/SOURCES.txt` & `quantrocket-moonchart-2.9.0.2/quantrocket_moonchart.egg-info/SOURCES.txt`
...
### Comparing `quantrocket-moonchart-2.8.0.0/setup.py` & `quantrocket-moonchart-2.9.0.2/setup.py`
...
### Comparing `quantrocket-moonchart-2.8.0.0/versioneer.py` & `quantrocket-moonchart-2.9.0.2/versioneer.py`
