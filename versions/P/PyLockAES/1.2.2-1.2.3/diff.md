# Comparing `tmp/PyLockAES-1.2.2.tar.gz` & `tmp/PyLockAES-1.2.3.tar.gz`
...
## Comparing `PyLockAES-1.2.2.tar` & `PyLockAES-1.2.3.tar`
...
### Comparing `PyLockAES-1.2.2/pylockaes/__init__.py` & `PyLockAES-1.2.3/pylockaes/__init__.py`
...
### Comparing `PyLockAES-1.2.2/pylockaes/encrypt_decrypt.py` & `PyLockAES-1.2.3/pylockaes/encrypt_decrypt.py`
