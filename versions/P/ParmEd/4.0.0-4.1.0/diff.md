# Comparing `tmp/ParmEd-4.0.0.tar.gz` & `tmp/ParmEd-4.1.0.tar.gz`
...
## Comparing `ParmEd-4.0.0.tar` & `ParmEd-4.1.0.tar`
...
### Comparing `ParmEd-4.0.0/ParmEd.egg-info/SOURCES.txt` & `ParmEd-4.1.0/ParmEd.egg-info/SOURCES.txt`
...
### Comparing `ParmEd-4.0.0/README.md` & `ParmEd-4.1.0/README.md`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/examples/amber/ala2_solv.parm7` & `ParmEd-4.1.0/examples/amber/ala2_solv.parm7`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/examples/amber/ala2_solv.rst7` & `ParmEd-4.1.0/examples/amber/ala2_solv.rst7`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/examples/amber/ala5_gas.parm7` & `ParmEd-4.1.0/examples/amber/ala5_gas.parm7`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/examples/amber/ala5_gas.rst7` & `ParmEd-4.1.0/examples/amber/ala5_gas.rst7`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/examples/amber/simulate_amber_gb.py` & `ParmEd-4.1.0/examples/amber/simulate_amber_gb.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/examples/amber/simulate_amber_pme.py` & `ParmEd-4.1.0/examples/amber/simulate_amber_pme.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/examples/charmm/ala2_charmmgui.crd` & `ParmEd-4.1.0/examples/charmm/ala2_charmmgui.crd`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/examples/charmm/ala2_charmmgui.psf` & `ParmEd-4.1.0/examples/charmm/ala2_charmmgui.psf`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/examples/charmm/ala5_autopsf.pdb` & `ParmEd-4.1.0/examples/charmm/ala5_autopsf.pdb`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/examples/charmm/ala5_autopsf.psf` & `ParmEd-4.1.0/examples/charmm/ala5_autopsf.psf`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/examples/charmm/simulate_charmm_gb.py` & `ParmEd-4.1.0/examples/charmm/simulate_charmm_gb.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/examples/charmm/simulate_charmm_gui.py` & `ParmEd-4.1.0/examples/charmm/simulate_charmm_gui.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/examples/charmm/toppar/par_all36_prot.prm` & `ParmEd-4.1.0/examples/charmm/toppar/par_all36_prot.prm`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/examples/charmm/toppar/toppar_water_ions.str` & `ParmEd-4.1.0/examples/charmm/toppar/toppar_water_ions.str`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/examples/gromacs/dhfr_gas.gro` & `ParmEd-4.1.0/examples/gromacs/dhfr_gas.gro`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/examples/gromacs/dhfr_gas.top` & `ParmEd-4.1.0/examples/gromacs/dhfr_gas.top`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/examples/gromacs/dhfr_pme.gro` & `ParmEd-4.1.0/examples/gromacs/dhfr_pme.gro`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/examples/gromacs/dhfr_pme.top` & `ParmEd-4.1.0/examples/gromacs/dhfr_pme.top`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/examples/gromacs/simulate_gromacs_gb.py` & `ParmEd-4.1.0/examples/gromacs/simulate_gromacs_gb.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/examples/gromacs/simulate_gromacs_pme.py` & `ParmEd-4.1.0/examples/gromacs/simulate_gromacs_pme.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/examples/rosetta/simulate_ala12_mutant.py` & `ParmEd-4.1.0/examples/rosetta/simulate_ala12_mutant.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/__init__.py` & `ParmEd-4.1.0/parmed/__init__.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/amber/__init__.py` & `ParmEd-4.1.0/parmed/amber/__init__.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/amber/_amberparm.py` & `ParmEd-4.1.0/parmed/amber/_amberparm.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/amber/_chamberparm.py` & `ParmEd-4.1.0/parmed/amber/_chamberparm.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/amber/_tinkerparm.py` & `ParmEd-4.1.0/parmed/amber/_tinkerparm.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/amber/amberformat.py` & `ParmEd-4.1.0/parmed/amber/amberformat.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/amber/asciicrd.py` & `ParmEd-4.1.0/parmed/amber/asciicrd.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/amber/mask.py` & `ParmEd-4.1.0/parmed/amber/mask.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/amber/mdin/cntrl.py` & `ParmEd-4.1.0/parmed/amber/mdin/cntrl.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/amber/mdin/ewald.py` & `ParmEd-4.1.0/parmed/amber/mdin/ewald.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/amber/mdin/mdin.py` & `ParmEd-4.1.0/parmed/amber/mdin/mdin.py`
...
### Comparing `ParmEd-4.0.0/parmed/amber/mdin/pb.py` & `ParmEd-4.1.0/parmed/amber/mdin/pb.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/amber/mdin/qmmm.py` & `ParmEd-4.1.0/parmed/amber/mdin/qmmm.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/amber/netcdffiles.py` & `ParmEd-4.1.0/parmed/amber/netcdffiles.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/amber/offlib.py` & `ParmEd-4.1.0/parmed/amber/offlib.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/amber/parameters.py` & `ParmEd-4.1.0/parmed/amber/parameters.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/amber/readparm.py` & `ParmEd-4.1.0/parmed/amber/readparm.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/amber/titratable_residues.py` & `ParmEd-4.1.0/parmed/amber/titratable_residues.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/charmm/__init__.py` & `ParmEd-4.1.0/parmed/charmm/__init__.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/charmm/_charmmfile.py` & `ParmEd-4.1.0/parmed/charmm/_charmmfile.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/charmm/charmmcrds.py` & `ParmEd-4.1.0/parmed/charmm/charmmcrds.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/charmm/parameters.py` & `ParmEd-4.1.0/parmed/charmm/parameters.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/charmm/psf.py` & `ParmEd-4.1.0/parmed/charmm/psf.py`
...
### Comparing `ParmEd-4.0.0/parmed/constants.py` & `ParmEd-4.1.0/parmed/constants.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/dlpoly/dlpolyconfig.py` & `ParmEd-4.1.0/parmed/dlpoly/dlpolyconfig.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/dlpoly/dlpolyfield.py` & `ParmEd-4.1.0/parmed/dlpoly/dlpolyfield.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/entos/converters.py` & `ParmEd-4.1.0/parmed/entos/converters.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/entos/imports.py` & `ParmEd-4.1.0/parmed/entos/imports.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/exceptions.py` & `ParmEd-4.1.0/parmed/exceptions.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/formats/__init__.py` & `ParmEd-4.1.0/parmed/formats/__init__.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/formats/mol2.py` & `ParmEd-4.1.0/parmed/formats/mol2.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/formats/pdb.py` & `ParmEd-4.1.0/parmed/formats/pdb.py`
...
### Comparing `ParmEd-4.0.0/parmed/formats/pdbx/PdbxContainers.py` & `ParmEd-4.1.0/parmed/formats/pdbx/PdbxContainers.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/formats/pdbx/PdbxReader.py` & `ParmEd-4.1.0/parmed/formats/pdbx/PdbxReader.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/formats/pdbx/PdbxWriter.py` & `ParmEd-4.1.0/parmed/formats/pdbx/PdbxWriter.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/formats/pdbx/__init__.py` & `ParmEd-4.1.0/parmed/formats/pdbx/__init__.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/formats/pqr.py` & `ParmEd-4.1.0/parmed/formats/pqr.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/formats/psf.py` & `ParmEd-4.1.0/parmed/formats/psf.py`
...
### Comparing `ParmEd-4.0.0/parmed/formats/registry.py` & `ParmEd-4.1.0/parmed/formats/registry.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/formats/sdf.py` & `ParmEd-4.1.0/parmed/formats/sdf.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/geometry.py` & `ParmEd-4.1.0/parmed/geometry.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/gromacs/__init__.py` & `ParmEd-4.1.0/parmed/gromacs/__init__.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/gromacs/_cpp.py` & `ParmEd-4.1.0/parmed/gromacs/_cpp.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/gromacs/_gromacsfile.py` & `ParmEd-4.1.0/parmed/gromacs/_gromacsfile.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/gromacs/gromacsgro.py` & `ParmEd-4.1.0/parmed/gromacs/gromacsgro.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/gromacs/gromacstop.py` & `ParmEd-4.1.0/parmed/gromacs/gromacstop.py`
...
### Comparing `ParmEd-4.0.0/parmed/modeller/data/ccd_residue_templates.json` & `ParmEd-4.1.0/parmed/modeller/data/ccd_residue_templates.json`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/modeller/data/standard_residues.lib` & `ParmEd-4.1.0/parmed/modeller/data/standard_residues.lib`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/modeller/residue.py` & `ParmEd-4.1.0/parmed/modeller/residue.py`
...
### Comparing `ParmEd-4.0.0/parmed/modeller/standardtemplates.py` & `ParmEd-4.1.0/parmed/modeller/standardtemplates.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/namd/namdbinfiles.py` & `ParmEd-4.1.0/parmed/namd/namdbinfiles.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/openmm/__init__.py` & `ParmEd-4.1.0/parmed/openmm/__init__.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/openmm/parameters.py` & `ParmEd-4.1.0/parmed/openmm/parameters.py`
...
### Comparing `ParmEd-4.0.0/parmed/openmm/reporters.py` & `ParmEd-4.1.0/parmed/openmm/reporters.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/openmm/topsystem.py` & `ParmEd-4.1.0/parmed/openmm/topsystem.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/openmm/utils.py` & `ParmEd-4.1.0/parmed/openmm/utils.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/openmm/xmlfile.py` & `ParmEd-4.1.0/parmed/openmm/xmlfile.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/parameters.py` & `ParmEd-4.1.0/parmed/parameters.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/periodic_table.py` & `ParmEd-4.1.0/parmed/periodic_table.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/rdkit/rdkit.py` & `ParmEd-4.1.0/parmed/rdkit/rdkit.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/residue.py` & `ParmEd-4.1.0/parmed/residue.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/rosetta/pose.py` & `ParmEd-4.1.0/parmed/rosetta/pose.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/scripts.py` & `ParmEd-4.1.0/parmed/scripts.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/structure.py` & `ParmEd-4.1.0/parmed/structure.py`
...
### Comparing `ParmEd-4.0.0/parmed/tinker/parameterfile.py` & `ParmEd-4.1.0/parmed/tinker/parameterfile.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/tinker/system.py` & `ParmEd-4.1.0/parmed/tinker/system.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/tinker/tinkerfiles.py` & `ParmEd-4.1.0/parmed/tinker/tinkerfiles.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/tinker/topologyobjects.py` & `ParmEd-4.1.0/parmed/tinker/topologyobjects.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/tools/actions.py` & `ParmEd-4.1.0/parmed/tools/actions.py`
...
### Comparing `ParmEd-4.0.0/parmed/tools/add1264.py` & `ParmEd-4.1.0/parmed/tools/add1264.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/tools/addljtype.py` & `ParmEd-4.1.0/parmed/tools/addljtype.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/tools/argumentlist.py` & `ParmEd-4.1.0/parmed/tools/argumentlist.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/tools/changeradii.py` & `ParmEd-4.1.0/parmed/tools/changeradii.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/tools/checkvalidity.py` & `ParmEd-4.1.0/parmed/tools/checkvalidity.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/tools/exceptions.py` & `ParmEd-4.1.0/parmed/tools/exceptions.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/tools/logos.py` & `ParmEd-4.1.0/parmed/tools/logos.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/tools/parmed_cmd.py` & `ParmEd-4.1.0/parmed/tools/parmed_cmd.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/tools/parmlist.py` & `ParmEd-4.1.0/parmed/tools/parmlist.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/tools/simulations/openmm.py` & `ParmEd-4.1.0/parmed/tools/simulations/openmm.py`
...
### Comparing `ParmEd-4.0.0/parmed/tools/simulations/sanderapi.py` & `ParmEd-4.1.0/parmed/tools/simulations/sanderapi.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/topologyobjects.py` & `ParmEd-4.1.0/parmed/topologyobjects.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/unit/__init__.py` & `ParmEd-4.1.0/parmed/unit/__init__.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/unit/basedimension.py` & `ParmEd-4.1.0/parmed/unit/basedimension.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/unit/baseunit.py` & `ParmEd-4.1.0/parmed/unit/baseunit.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/unit/constants.py` & `ParmEd-4.1.0/parmed/unit/constants.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/unit/mymatrix.py` & `ParmEd-4.1.0/parmed/unit/mymatrix.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/unit/prefix.py` & `ParmEd-4.1.0/parmed/unit/prefix.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/unit/quantity.py` & `ParmEd-4.1.0/parmed/unit/quantity.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/unit/standard_dimensions.py` & `ParmEd-4.1.0/parmed/unit/standard_dimensions.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/unit/unit.py` & `ParmEd-4.1.0/parmed/unit/unit.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/unit/unit_definitions.py` & `ParmEd-4.1.0/parmed/unit/unit_definitions.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/unit/unit_math.py` & `ParmEd-4.1.0/parmed/unit/unit_math.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/unit/unit_operators.py` & `ParmEd-4.1.0/parmed/unit/unit_operators.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/utils/__init__.py` & `ParmEd-4.1.0/parmed/utils/__init__.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/utils/decorators.py` & `ParmEd-4.1.0/parmed/utils/decorators.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/utils/fortranformat/FortranRecordReader.py` & `ParmEd-4.1.0/parmed/utils/fortranformat/FortranRecordReader.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/utils/fortranformat/FortranRecordWriter.py` & `ParmEd-4.1.0/parmed/utils/fortranformat/FortranRecordWriter.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/utils/fortranformat/__init__.py` & `ParmEd-4.1.0/parmed/utils/fortranformat/__init__.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/utils/fortranformat/_edit_descriptors.py` & `ParmEd-4.1.0/parmed/utils/fortranformat/_edit_descriptors.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/utils/fortranformat/_input.py` & `ParmEd-4.1.0/parmed/utils/fortranformat/_input.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/utils/fortranformat/_lexer.py` & `ParmEd-4.1.0/parmed/utils/fortranformat/_lexer.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/utils/fortranformat/_misc.py` & `ParmEd-4.1.0/parmed/utils/fortranformat/_misc.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/utils/fortranformat/_output.py` & `ParmEd-4.1.0/parmed/utils/fortranformat/_output.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/utils/fortranformat/_parser.py` & `ParmEd-4.1.0/parmed/utils/fortranformat/_parser.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/utils/fortranformat/config.py` & `ParmEd-4.1.0/parmed/utils/fortranformat/config.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/utils/io.py` & `ParmEd-4.1.0/parmed/utils/io.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/utils/netcdf.py` & `ParmEd-4.1.0/parmed/utils/netcdf.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/utils/pairlist.py` & `ParmEd-4.1.0/parmed/utils/pairlist.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/utils/pandautils.py` & `ParmEd-4.1.0/parmed/utils/pandautils.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/utils/timer.py` & `ParmEd-4.1.0/parmed/utils/timer.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/parmed/vec3.py` & `ParmEd-4.1.0/parmed/vec3.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/setup.py` & `ParmEd-4.1.0/setup.py`
...
### Comparing `ParmEd-4.0.0/src/_rdparm.cpp` & `ParmEd-4.1.0/src/_rdparm.cpp`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/src/main.cpp` & `ParmEd-4.1.0/src/main.cpp`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/src/readparm.cpp` & `ParmEd-4.1.0/src/readparm.cpp`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/src/readparm.h` & `ParmEd-4.1.0/src/readparm.h`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_format_conversions.py` & `ParmEd-4.1.0/test/test_format_conversions.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_openmm_amber.py` & `ParmEd-4.1.0/test/test_openmm_amber.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_openmm_amber_forces.py` & `ParmEd-4.1.0/test/test_openmm_amber_forces.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_openmm_charmm.py` & `ParmEd-4.1.0/test/test_openmm_charmm.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_openmm_gromacs.py` & `ParmEd-4.1.0/test/test_openmm_gromacs.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_openmm_reporters.py` & `ParmEd-4.1.0/test/test_openmm_reporters.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_parmed_amber.py` & `ParmEd-4.1.0/test/test_parmed_amber.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_parmed_charmm.py` & `ParmEd-4.1.0/test/test_parmed_charmm.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_parmed_cif.py` & `ParmEd-4.1.0/test/test_parmed_cif.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_parmed_dlpoly.py` & `ParmEd-4.1.0/test/test_parmed_dlpoly.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_parmed_entos.py` & `ParmEd-4.1.0/test/test_parmed_entos.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_parmed_formats.py` & `ParmEd-4.1.0/test/test_parmed_formats.py`
...
### Comparing `ParmEd-4.0.0/test/test_parmed_genopen.py` & `ParmEd-4.1.0/test/test_parmed_genopen.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_parmed_geometry.py` & `ParmEd-4.1.0/test/test_parmed_geometry.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_parmed_gromacs.py` & `ParmEd-4.1.0/test/test_parmed_gromacs.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_parmed_gromacs_cpp.py` & `ParmEd-4.1.0/test/test_parmed_gromacs_cpp.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_parmed_misc.py` & `ParmEd-4.1.0/test/test_parmed_misc.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_parmed_modeller.py` & `ParmEd-4.1.0/test/test_parmed_modeller.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_parmed_namd.py` & `ParmEd-4.1.0/test/test_parmed_namd.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_parmed_netcdf.py` & `ParmEd-4.1.0/test/test_parmed_netcdf.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_parmed_openmm.py` & `ParmEd-4.1.0/test/test_parmed_openmm.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_parmed_pandas.py` & `ParmEd-4.1.0/test/test_parmed_pandas.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_parmed_parameterset.py` & `ParmEd-4.1.0/test/test_parmed_parameterset.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_parmed_rdkit.py` & `ParmEd-4.1.0/test/test_parmed_rdkit.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_parmed_residue.py` & `ParmEd-4.1.0/test/test_parmed_residue.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_parmed_rosetta.py` & `ParmEd-4.1.0/test/test_parmed_rosetta.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_parmed_serialization.py` & `ParmEd-4.1.0/test/test_parmed_serialization.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_parmed_structure.py` & `ParmEd-4.1.0/test/test_parmed_structure.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_parmed_structure_slicing.py` & `ParmEd-4.1.0/test/test_parmed_structure_slicing.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_parmed_tinker.py` & `ParmEd-4.1.0/test/test_parmed_tinker.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_parmed_topologyobjects.py` & `ParmEd-4.1.0/test/test_parmed_topologyobjects.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_parmed_unit.py` & `ParmEd-4.1.0/test/test_parmed_unit.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_parmedtools_actions.py` & `ParmEd-4.1.0/test/test_parmedtools_actions.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_parmedtools_parmlist.py` & `ParmEd-4.1.0/test/test_parmedtools_parmlist.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/test/test_vec3.py` & `ParmEd-4.1.0/test/test_vec3.py`

 * *Files identical despite different names*

### Comparing `ParmEd-4.0.0/versioneer.py` & `ParmEd-4.1.0/versioneer.py`
