# Comparing `tmp/iosense_connect-2.0.5.tar.gz` & `tmp/iosense_connect-2.0.7.tar.gz`
...
## Comparing `iosense_connect-2.0.5.tar` & `iosense_connect-2.0.7.tar`
...
### Comparing `iosense_connect-2.0.5/README.md` & `iosense_connect-2.0.7/README.md`
...
### Comparing `iosense_connect-2.0.5/iosense_connect/data_access.py` & `iosense_connect-2.0.7/iosense_connect/data_access.py`
