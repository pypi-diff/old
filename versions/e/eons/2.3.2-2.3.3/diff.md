# Comparing `tmp/eons-2.3.2.tar.gz` & `tmp/eons-2.3.3.tar.gz`
...
## Comparing `eons-2.3.2.tar` & `eons-2.3.3.tar`
...
### Comparing `eons-2.3.2/PKG-INFO` & `eons-2.3.3/PKG-INFO`
...
### Comparing `eons-2.3.2/README.md` & `eons-2.3.3/README.md`

 * *Files identical despite different names*

### Comparing `eons-2.3.2/pkg/eons/eons.py` & `eons-2.3.3/pkg/eons/eons.py`
...
### Comparing `eons-2.3.2/pkg/eons/resolve/resolve_find_by_fetch.py` & `eons-2.3.3/pkg/eons/resolve/resolve_find_by_fetch.py`

 * *Files identical despite different names*

### Comparing `eons-2.3.2/pkg/eons/resolve/resolve_import_module.py` & `eons-2.3.3/pkg/eons/resolve/resolve_import_module.py`

 * *Files identical despite different names*

### Comparing `eons-2.3.2/pkg/eons.egg-info/PKG-INFO` & `eons-2.3.3/pkg/eons.egg-info/PKG-INFO`
...
### Comparing `eons-2.3.2/setup.cfg` & `eons-2.3.3/setup.cfg`
