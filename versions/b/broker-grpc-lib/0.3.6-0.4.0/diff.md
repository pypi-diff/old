# Comparing `tmp/broker_grpc_lib-0.3.6.tar.gz` & `tmp/broker_grpc_lib-0.4.0.tar.gz`
...
## Comparing `broker_grpc_lib-0.3.6.tar` & `broker_grpc_lib-0.4.0.tar`
...
### Comparing `broker_grpc_lib-0.3.6/README.md` & `broker_grpc_lib-0.4.0/README.md`

 * *Files identical despite different names*

### Comparing `broker_grpc_lib-0.3.6/broker_grpc_lib/lib/broker_handler.py` & `broker_grpc_lib-0.4.0/broker_grpc_lib/lib/broker_handler.py`

 * *Files identical despite different names*

### Comparing `broker_grpc_lib-0.3.6/broker_grpc_lib/lib/grpc_client.py` & `broker_grpc_lib-0.4.0/broker_grpc_lib/lib/grpc_client.py`

 * *Files identical despite different names*

### Comparing `broker_grpc_lib-0.3.6/broker_grpc_lib/lib/rabbitmq_handler.py` & `broker_grpc_lib-0.4.0/broker_grpc_lib/lib/rabbitmq_handler.py`
...
### Comparing `broker_grpc_lib-0.3.6/broker_grpc_lib.egg-info/SOURCES.txt` & `broker_grpc_lib-0.4.0/broker_grpc_lib.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `broker_grpc_lib-0.3.6/setup.py` & `broker_grpc_lib-0.4.0/setup.py`
...
### Comparing `broker_grpc_lib-0.3.6/tests/units/test_grpc_client.py` & `broker_grpc_lib-0.4.0/tests/units/test_grpc_client.py`

 * *Files identical despite different names*

### Comparing `broker_grpc_lib-0.3.6/tests/units/test_rabbitmq_handler.py` & `broker_grpc_lib-0.4.0/tests/units/test_rabbitmq_handler.py`
