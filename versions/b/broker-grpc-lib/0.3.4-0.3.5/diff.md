# Comparing `tmp/broker_grpc_lib-0.3.4.tar.gz` & `tmp/broker_grpc_lib-0.3.5.tar.gz`
...
## Comparing `broker_grpc_lib-0.3.4.tar` & `broker_grpc_lib-0.3.5.tar`
...
### Comparing `broker_grpc_lib-0.3.4/README.md` & `broker_grpc_lib-0.3.5/README.md`

 * *Files identical despite different names*

### Comparing `broker_grpc_lib-0.3.4/broker_grpc_lib/lib/broker_handler.py` & `broker_grpc_lib-0.3.5/broker_grpc_lib/lib/broker_handler.py`

 * *Files identical despite different names*

### Comparing `broker_grpc_lib-0.3.4/broker_grpc_lib/lib/grpc_client.py` & `broker_grpc_lib-0.3.5/broker_grpc_lib/lib/grpc_client.py`

 * *Files identical despite different names*

### Comparing `broker_grpc_lib-0.3.4/broker_grpc_lib/lib/rabbitmq_handler.py` & `broker_grpc_lib-0.3.5/broker_grpc_lib/lib/rabbitmq_handler.py`
...
### Comparing `broker_grpc_lib-0.3.4/broker_grpc_lib.egg-info/SOURCES.txt` & `broker_grpc_lib-0.3.5/broker_grpc_lib.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `broker_grpc_lib-0.3.4/setup.py` & `broker_grpc_lib-0.3.5/setup.py`
...
### Comparing `broker_grpc_lib-0.3.4/tests/units/test_grpc_client.py` & `broker_grpc_lib-0.3.5/tests/units/test_grpc_client.py`

 * *Files identical despite different names*

### Comparing `broker_grpc_lib-0.3.4/tests/units/test_rabbitmq_handler.py` & `broker_grpc_lib-0.3.5/tests/units/test_rabbitmq_handler.py`
