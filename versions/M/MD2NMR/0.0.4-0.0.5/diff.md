# Comparing `tmp/MD2NMR-0.0.4.tar.gz` & `tmp/MD2NMR-0.0.5.tar.gz`
...
## Comparing `MD2NMR-0.0.4.tar` & `MD2NMR-0.0.5.tar`
...
### Comparing `MD2NMR-0.0.4/LICENSE` & `MD2NMR-0.0.5/LICENSE`

 * *Files identical despite different names*

### Comparing `MD2NMR-0.0.4/README.md` & `MD2NMR-0.0.5/README.md`
