# Comparing `tmp/ramanchada2-0.0.3.tar.gz` & `tmp/ramanchada2-0.0.4.tar.gz`
...
### Comparing `ramanchada2-0.0.3/LICENSE` & `ramanchada2-0.0.4/LICENSE`
...
### Comparing `ramanchada2-0.0.3/src/ramanchada2/io/experimental/rc1_parser/io.py` & `ramanchada2-0.0.4/src/ramanchada2/io/experimental/rc1_parser/io.py`
...
### Comparing `ramanchada2-0.0.3/src/ramanchada2/spectrum/arithmetics/add.py` & `ramanchada2-0.0.4/src/ramanchada2/spectrum/arithmetics/add.py`
...
### Comparing `ramanchada2-0.0.3/src/ramanchada2/spectrum/baseline/moving_minimum.py` & `ramanchada2-0.0.4/src/ramanchada2/spectrum/baseline/moving_minimum.py`

 * *Files identical despite different names*

### Comparing `ramanchada2-0.0.3/src/ramanchada2/spectrum/calc/central_moments.py` & `ramanchada2-0.0.4/src/ramanchada2/spectrum/calc/central_moments.py`

 * *Files identical despite different names*

### Comparing `ramanchada2-0.0.3/src/ramanchada2/spectrum/calibration/by_deltas.py` & `ramanchada2-0.0.4/src/ramanchada2/spectrum/calibration/by_deltas.py`

 * *Files identical despite different names*

### Comparing `ramanchada2-0.0.3/src/ramanchada2/spectrum/calibration/change_x_units.py` & `ramanchada2-0.0.4/src/ramanchada2/spectrum/calibration/change_x_units.py`

 * *Files identical despite different names*

### Comparing `ramanchada2-0.0.3/src/ramanchada2/spectrum/calibration/normalize.py` & `ramanchada2-0.0.4/src/ramanchada2/spectrum/calibration/normalize.py`

 * *Files identical despite different names*

### Comparing `ramanchada2-0.0.3/src/ramanchada2/spectrum/calibration/scale_xaxis.py` & `ramanchada2-0.0.4/src/ramanchada2/spectrum/calibration/scale_xaxis.py`

 * *Files identical despite different names*

### Comparing `ramanchada2-0.0.3/src/ramanchada2/spectrum/calibration/set_new_xaxis.py` & `ramanchada2-0.0.4/src/ramanchada2/spectrum/calibration/set_new_xaxis.py`

 * *Files identical despite different names*

### Comparing `ramanchada2-0.0.3/src/ramanchada2/spectrum/creators/from_cache_or_calc.py` & `ramanchada2-0.0.4/src/ramanchada2/spectrum/creators/from_cache_or_calc.py`

 * *Files identical despite different names*

### Comparing `ramanchada2-0.0.3/src/ramanchada2/spectrum/creators/from_delta_lines.py` & `ramanchada2-0.0.4/src/ramanchada2/spectrum/creators/from_delta_lines.py`

 * *Files identical despite different names*

### Comparing `ramanchada2-0.0.3/src/ramanchada2/spectrum/creators/from_local_file.py` & `ramanchada2-0.0.4/src/ramanchada2/spectrum/creators/from_local_file.py`

 * *Files identical despite different names*

### Comparing `ramanchada2-0.0.3/src/ramanchada2/spectrum/creators/from_simulation.py` & `ramanchada2-0.0.4/src/ramanchada2/spectrum/creators/from_simulation.py`

 * *Files identical despite different names*

### Comparing `ramanchada2-0.0.3/src/ramanchada2/spectrum/creators/from_spectral_component_collection.py` & `ramanchada2-0.0.4/src/ramanchada2/spectrum/creators/from_spectral_component_collection.py`

 * *Files identical despite different names*

### Comparing `ramanchada2-0.0.3/src/ramanchada2/spectrum/creators/from_theoretical_lines.py` & `ramanchada2-0.0.4/src/ramanchada2/spectrum/creators/from_theoretical_lines.py`

 * *Files identical despite different names*

### Comparing `ramanchada2-0.0.3/src/ramanchada2/spectrum/filters/add_poisson_noise.py` & `ramanchada2-0.0.4/src/ramanchada2/spectrum/filters/add_poisson_noise.py`

 * *Files identical despite different names*

### Comparing `ramanchada2-0.0.3/src/ramanchada2/spectrum/filters/convolve.py` & `ramanchada2-0.0.4/src/ramanchada2/spectrum/filters/convolve.py`

 * *Files identical despite different names*

### Comparing `ramanchada2-0.0.3/src/ramanchada2/spectrum/filters/drop_spikes.py` & `ramanchada2-0.0.4/src/ramanchada2/spectrum/filters/drop_spikes.py`

 * *Files identical despite different names*

### Comparing `ramanchada2-0.0.3/src/ramanchada2/spectrum/filters/moving_average.py` & `ramanchada2-0.0.4/src/ramanchada2/spectrum/filters/moving_average.py`

 * *Files identical despite different names*

### Comparing `ramanchada2-0.0.3/src/ramanchada2/spectrum/filters/pad_zeros.py` & `ramanchada2-0.0.4/src/ramanchada2/spectrum/filters/pad_zeros.py`

 * *Files identical despite different names*

### Comparing `ramanchada2-0.0.3/src/ramanchada2/spectrum/filters/resampling.py` & `ramanchada2-0.0.4/src/ramanchada2/spectrum/filters/resampling.py`

 * *Files identical despite different names*

### Comparing `ramanchada2-0.0.3/src/ramanchada2/spectrum/filters/sharpen_lines.py` & `ramanchada2-0.0.4/src/ramanchada2/spectrum/filters/sharpen_lines.py`

 * *Files identical despite different names*

### Comparing `ramanchada2-0.0.3/src/ramanchada2/spectrum/filters/smoothing.py` & `ramanchada2-0.0.4/src/ramanchada2/spectrum/filters/smoothing.py`

 * *Files identical despite different names*

### Comparing `ramanchada2-0.0.3/src/ramanchada2/spectrum/filters/trim_axes.py` & `ramanchada2-0.0.4/src/ramanchada2/spectrum/filters/trim_axes.py`

 * *Files identical despite different names*

### Comparing `ramanchada2-0.0.3/src/ramanchada2/spectrum/peaks/find_peaks.py` & `ramanchada2-0.0.4/src/ramanchada2/spectrum/peaks/find_peaks.py`
...
### Comparing `ramanchada2-0.0.3/src/ramanchada2/spectrum/peaks/find_peaks_BayesianGaussianMixture.py` & `ramanchada2-0.0.4/src/ramanchada2/spectrum/peaks/find_peaks_BayesianGaussianMixture.py`

 * *Files identical despite different names*

### Comparing `ramanchada2-0.0.3/src/ramanchada2/spectrum/peaks/get_fitted_peaks.py` & `ramanchada2-0.0.4/src/ramanchada2/spectrum/peaks/get_fitted_peaks.py`

 * *Files identical despite different names*

### Comparing `ramanchada2-0.0.3/src/ramanchada2/spectrum/spectrum.py` & `ramanchada2-0.0.4/src/ramanchada2/spectrum/spectrum.py`
...
### Comparing `ramanchada2-0.0.3/src/ramanchada2/theoretical_lines/model_from_lines.py` & `ramanchada2-0.0.4/src/ramanchada2/theoretical_lines/model_from_lines.py`

 * *Files identical despite different names*

### Comparing `ramanchada2-0.0.3/src/ramanchada2.egg-info/PKG-INFO` & `ramanchada2-0.0.4/src/ramanchada2.egg-info/PKG-INFO`
