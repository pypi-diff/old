# Comparing `tmp/horsetalk-0.1.0.tar.gz` & `tmp/horsetalk-0.2.0.tar.gz`
...
## Comparing `horsetalk-0.1.0.tar` & `horsetalk-0.2.0.tar`
...
### Comparing `horsetalk-0.1.0/LICENSE` & `horsetalk-0.2.0/LICENSE`

 * *Files identical despite different names*

### Comparing `horsetalk-0.1.0/pyproject.toml` & `horsetalk-0.2.0/pyproject.toml`
...
### Comparing `horsetalk-0.1.0/PKG-INFO` & `horsetalk-0.2.0/PKG-INFO`
