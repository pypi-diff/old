# Comparing `tmp/hmfs-1.1.5132.tar.gz` & `tmp/hmfs-1.1.6.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dist/hmfs-1.1.5132.tar", last modified: Fri Apr  7 07:51:01 2023, max compression
+gzip compressed data, was "dist/hmfs-1.1.6.tar", last modified: Wed Aug 24 12:07:38 2022, max compression
```

## Comparing `hmfs-1.1.5132.tar` & `hmfs-1.1.6.tar`

### file list

```diff
@@ -1,35 +1,1134 @@
-drwxrwxr-x   0 superpigy  (1000) superpigy  (1000)        0 2023-04-07 07:51:01.000000 hmfs-1.1.5132/
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      330 2023-04-07 07:51:01.000000 hmfs-1.1.5132/PKG-INFO
-drwxrwxr-x   0 superpigy  (1000) superpigy  (1000)        0 2023-04-07 07:51:01.000000 hmfs-1.1.5132/hamunafs/
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)        0 2022-10-12 00:41:11.000000 hmfs-1.1.5132/hamunafs/__init__.py
-drwxrwxr-x   0 superpigy  (1000) superpigy  (1000)        0 2023-04-07 07:51:01.000000 hmfs-1.1.5132/hamunafs/backends/
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      203 2022-08-24 10:45:13.000000 hmfs-1.1.5132/hamunafs/backends/__init__.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      917 2023-02-27 06:26:04.000000 hmfs-1.1.5132/hamunafs/backends/base.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     4030 2023-02-27 06:27:51.000000 hmfs-1.1.5132/hamunafs/backends/bk_minio.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     4362 2023-02-27 06:27:39.000000 hmfs-1.1.5132/hamunafs/backends/bk_qiniu.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     1233 2023-04-07 02:55:40.000000 hmfs-1.1.5132/hamunafs/backends/bk_share.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     5747 2023-02-27 06:28:08.000000 hmfs-1.1.5132/hamunafs/backends/bk_wy.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      937 2023-01-31 04:14:05.000000 hmfs-1.1.5132/hamunafs/backends/fetcher.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)    20512 2023-04-07 03:48:42.000000 hmfs-1.1.5132/hamunafs/client.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      189 2021-11-18 09:55:13.000000 hmfs-1.1.5132/hamunafs/conf.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     9389 2023-03-23 03:02:23.000000 hmfs-1.1.5132/hamunafs/server.py
-drwxrwxr-x   0 superpigy  (1000) superpigy  (1000)        0 2023-04-07 07:51:01.000000 hmfs-1.1.5132/hamunafs/sqlite/
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     4895 2021-11-17 08:14:48.000000 hmfs-1.1.5132/hamunafs/sqlite/__init__.py
-drwxrwxr-x   0 superpigy  (1000) superpigy  (1000)        0 2023-04-07 07:51:01.000000 hmfs-1.1.5132/hamunafs/utils/
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)        0 2022-10-12 00:41:11.000000 hmfs-1.1.5132/hamunafs/utils/__init__.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     5300 2022-05-20 12:24:19.000000 hmfs-1.1.5132/hamunafs/utils/cachemanager.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     4578 2022-10-20 11:01:55.000000 hmfs-1.1.5132/hamunafs/utils/img_compressor.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     6528 2022-08-24 11:14:39.000000 hmfs-1.1.5132/hamunafs/utils/minio.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     3579 2022-08-24 10:04:27.000000 hmfs-1.1.5132/hamunafs/utils/mqtt.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     5226 2023-02-03 04:48:33.000000 hmfs-1.1.5132/hamunafs/utils/nsqmanager.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)    17182 2023-01-04 13:01:16.000000 hmfs-1.1.5132/hamunafs/utils/redisutil.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      633 2023-01-28 07:26:26.000000 hmfs-1.1.5132/hamunafs/utils/singleton_wrapper.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      932 2022-09-03 07:57:02.000000 hmfs-1.1.5132/hamunafs/utils/timeutil.py
-drwxrwxr-x   0 superpigy  (1000) superpigy  (1000)        0 2023-04-07 07:51:01.000000 hmfs-1.1.5132/hmfs.egg-info/
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      330 2023-04-07 07:51:01.000000 hmfs-1.1.5132/hmfs.egg-info/PKG-INFO
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      753 2023-04-07 07:51:01.000000 hmfs-1.1.5132/hmfs.egg-info/SOURCES.txt
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)        1 2023-04-07 07:51:01.000000 hmfs-1.1.5132/hmfs.egg-info/dependency_links.txt
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      146 2023-04-07 07:51:01.000000 hmfs-1.1.5132/hmfs.egg-info/requires.txt
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)        9 2023-04-07 07:51:01.000000 hmfs-1.1.5132/hmfs.egg-info/top_level.txt
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)       38 2023-04-07 07:51:01.000000 hmfs-1.1.5132/setup.cfg
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      731 2023-04-07 07:50:57.000000 hmfs-1.1.5132/setup.py
...
### Comparing `hmfs-1.1.5132/hamunafs/backends/bk_minio.py` & `hmfs-1.1.6/hamunafs/backends/bk_minio.py`
...
### Comparing `hmfs-1.1.5132/hamunafs/backends/bk_wy.py` & `hmfs-1.1.6/hamunafs/backends/bk_qiniu.py`
...
### Comparing `hmfs-1.1.5132/hamunafs/client.py` & `hmfs-1.1.6/hamunafs/client.py`
...
### Comparing `hmfs-1.1.5132/hamunafs/server.py` & `hmfs-1.1.6/hamunafs/server.py`
...
### Comparing `hmfs-1.1.5132/hamunafs/sqlite/__init__.py` & `hmfs-1.1.6/hamunafs/sqlite/__init__.py`

 * *Files identical despite different names*

### Comparing `hmfs-1.1.5132/hamunafs/utils/cachemanager.py` & `hmfs-1.1.6/hamunafs/utils/cachemanager.py`

 * *Files identical despite different names*

### Comparing `hmfs-1.1.5132/hamunafs/utils/minio.py` & `hmfs-1.1.6/hamunafs/utils/minio.py`

 * *Files identical despite different names*

### Comparing `hmfs-1.1.5132/hamunafs/utils/mqtt.py` & `hmfs-1.1.6/hamunafs/utils/mqtt.py`

 * *Files identical despite different names*

### Comparing `hmfs-1.1.5132/hamunafs/utils/nsqmanager.py` & `hmfs-1.1.6/hamunafs/utils/nsqmanager.py`
...
### Comparing `hmfs-1.1.5132/hamunafs/utils/redisutil.py` & `hmfs-1.1.6/hamunafs/utils/redisutil.py`
...
### Comparing `hmfs-1.1.5132/setup.py` & `hmfs-1.1.6/setup.py`
