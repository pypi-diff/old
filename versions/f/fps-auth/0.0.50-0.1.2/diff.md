# Comparing `tmp/fps_auth-0.0.50.tar.gz` & `tmp/fps_auth-0.1.2.tar.gz`

## Comparing `fps_auth-0.0.50.tar` & `fps_auth-0.1.2.tar`
...
### Comparing `fps_auth-0.0.50/fps_auth/backends.py` & `fps_auth-0.1.2/fps_auth/backends.py`
...
### Comparing `fps_auth-0.0.50/fps_auth/db.py` & `fps_auth-0.1.2/fps_auth/db.py`
...
### Comparing `fps_auth-0.0.50/.gitignore` & `fps_auth-0.1.2/.gitignore`

 * *Files identical despite different names*

### Comparing `fps_auth-0.0.50/COPYING.md` & `fps_auth-0.1.2/COPYING.md`

 * *Files identical despite different names*

### Comparing `fps_auth-0.0.50/pyproject.toml` & `fps_auth-0.1.2/pyproject.toml`
...
### Comparing `fps_auth-0.0.50/PKG-INFO` & `fps_auth-0.1.2/PKG-INFO`
