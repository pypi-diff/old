# Comparing `tmp/forbidden-9.2.tar.gz` & `tmp/forbidden-9.3.tar.gz`
...
## Comparing `forbidden-9.2.tar` & `forbidden-9.3.tar`
...
### Comparing `forbidden-9.2/PKG-INFO` & `forbidden-9.3/PKG-INFO`
...
### Comparing `forbidden-9.2/pyproject.toml` & `forbidden-9.3/pyproject.toml`
...
### Comparing `forbidden-9.2/src/forbidden/forbidden.py` & `forbidden-9.3/src/forbidden/forbidden.py`
...
### Comparing `forbidden-9.2/src/forbidden/user_agents.txt` & `forbidden-9.3/src/forbidden/user_agents.txt`
...
### Comparing `forbidden-9.2/src/forbidden.egg-info/PKG-INFO` & `forbidden-9.3/src/forbidden.egg-info/PKG-INFO`
...
### Comparing `forbidden-9.2/src/stresser/stresser.py` & `forbidden-9.3/src/stresser/stresser.py`
...
### Comparing `forbidden-9.2/src/stresser/user_agents.txt` & `forbidden-9.3/src/stresser/user_agents.txt`
