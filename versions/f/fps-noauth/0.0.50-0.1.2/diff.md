# Comparing `tmp/fps_noauth-0.0.50.tar.gz` & `tmp/fps_noauth-0.1.2.tar.gz`

## Comparing `fps_noauth-0.0.50.tar` & `fps_noauth-0.1.2.tar`
...
### Comparing `fps_noauth-0.0.50/fps_noauth/backends.py` & `fps_noauth-0.1.2/fps_noauth/backends.py`
...
### Comparing `fps_noauth-0.0.50/.gitignore` & `fps_noauth-0.1.2/.gitignore`

 * *Files identical despite different names*

### Comparing `fps_noauth-0.0.50/COPYING.md` & `fps_noauth-0.1.2/COPYING.md`

 * *Files identical despite different names*

### Comparing `fps_noauth-0.0.50/pyproject.toml` & `fps_noauth-0.1.2/pyproject.toml`
