# Comparing `tmp/fps_contents-0.0.50.tar.gz` & `tmp/fps_contents-0.1.2.tar.gz`

## Comparing `fps_contents-0.0.50.tar` & `fps_contents-0.1.2.tar`
...
### Comparing `fps_contents-0.0.50/fps_contents/fileid.py` & `fps_contents-0.1.2/fps_contents/fileid.py`
...
### Comparing `fps_contents-0.0.50/fps_contents/routes.py` & `fps_contents-0.1.2/fps_contents/routes.py`
...
### Comparing `fps_contents-0.0.50/.gitignore` & `fps_contents-0.1.2/.gitignore`

 * *Files identical despite different names*

### Comparing `fps_contents-0.0.50/COPYING.md` & `fps_contents-0.1.2/COPYING.md`

 * *Files identical despite different names*

### Comparing `fps_contents-0.0.50/pyproject.toml` & `fps_contents-0.1.2/pyproject.toml`
