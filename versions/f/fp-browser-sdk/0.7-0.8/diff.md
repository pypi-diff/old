# Comparing `tmp/fp_browser_sdk-0.7.tar.gz` & `tmp/fp_browser_sdk-0.8.tar.gz`
...
### Comparing `fp_browser_sdk-0.7/fp_browser_sdk/ext/webrtc.py` & `fp_browser_sdk-0.8/fp_browser_sdk/ext/webrtc.py`
