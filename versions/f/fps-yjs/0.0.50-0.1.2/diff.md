# Comparing `tmp/fps_yjs-0.0.50.tar.gz` & `tmp/fps_yjs-0.1.2.tar.gz`

## Comparing `fps_yjs-0.0.50.tar` & `fps_yjs-0.1.2.tar`
...
### Comparing `fps_yjs-0.0.50/fps_yjs/routes.py` & `fps_yjs-0.1.2/fps_yjs/routes.py`
...
### Comparing `fps_yjs-0.0.50/.gitignore` & `fps_yjs-0.1.2/.gitignore`

 * *Files identical despite different names*

### Comparing `fps_yjs-0.0.50/COPYING.md` & `fps_yjs-0.1.2/COPYING.md`

 * *Files identical despite different names*

### Comparing `fps_yjs-0.0.50/pyproject.toml` & `fps_yjs-0.1.2/pyproject.toml`
