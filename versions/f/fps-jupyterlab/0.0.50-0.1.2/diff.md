# Comparing `tmp/fps_jupyterlab-0.0.50.tar.gz` & `tmp/fps_jupyterlab-0.1.2.tar.gz`

## Comparing `fps_jupyterlab-0.0.50.tar` & `fps_jupyterlab-0.1.2.tar`
...
### Comparing `fps_jupyterlab-0.0.50/fps_jupyterlab/routes.py` & `fps_jupyterlab-0.1.2/fps_jupyterlab/routes.py`
...
### Comparing `fps_jupyterlab-0.0.50/.gitignore` & `fps_jupyterlab-0.1.2/.gitignore`

 * *Files identical despite different names*

### Comparing `fps_jupyterlab-0.0.50/COPYING.md` & `fps_jupyterlab-0.1.2/COPYING.md`

 * *Files identical despite different names*

### Comparing `fps_jupyterlab-0.0.50/pyproject.toml` & `fps_jupyterlab-0.1.2/pyproject.toml`
