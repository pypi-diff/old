# Comparing `tmp/fps_auth_fief-0.0.50.tar.gz` & `tmp/fps_auth_fief-0.1.2.tar.gz`

## Comparing `fps_auth_fief-0.0.50.tar` & `fps_auth_fief-0.1.2.tar`
...
### Comparing `fps_auth_fief-0.0.50/fps_auth_fief/backend.py` & `fps_auth_fief-0.1.2/fps_auth_fief/backend.py`
...
### Comparing `fps_auth_fief-0.0.50/fps_auth_fief/routes.py` & `fps_auth_fief-0.1.2/fps_auth_fief/routes.py`
...
### Comparing `fps_auth_fief-0.0.50/.gitignore` & `fps_auth_fief-0.1.2/.gitignore`

 * *Files identical despite different names*

### Comparing `fps_auth_fief-0.0.50/COPYING.md` & `fps_auth_fief-0.1.2/COPYING.md`

 * *Files identical despite different names*

### Comparing `fps_auth_fief-0.0.50/PKG-INFO` & `fps_auth_fief-0.1.2/PKG-INFO`
