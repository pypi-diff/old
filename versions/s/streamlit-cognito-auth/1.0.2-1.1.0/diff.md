# Comparing `tmp/streamlit-cognito-auth-1.0.2.tar.gz` & `tmp/streamlit-cognito-auth-1.1.0.tar.gz`
...
## Comparing `streamlit-cognito-auth-1.0.2.tar` & `streamlit-cognito-auth-1.1.0.tar`
...
### Comparing `streamlit-cognito-auth-1.0.2/LICENSE` & `streamlit-cognito-auth-1.1.0/LICENSE`

 * *Files identical despite different names*

### Comparing `streamlit-cognito-auth-1.0.2/PKG-INFO` & `streamlit-cognito-auth-1.1.0/PKG-INFO`
...
### Comparing `streamlit-cognito-auth-1.0.2/README.md` & `streamlit-cognito-auth-1.1.0/README.md`
...
### Comparing `streamlit-cognito-auth-1.0.2/setup.py` & `streamlit-cognito-auth-1.1.0/setup.py`
...
### Comparing `streamlit-cognito-auth-1.0.2/src/streamlit_cognito_auth/auth.py` & `streamlit-cognito-auth-1.1.0/src/streamlit_cognito_auth/auth.py`
...
### Comparing `streamlit-cognito-auth-1.0.2/src/streamlit_cognito_auth.egg-info/PKG-INFO` & `streamlit-cognito-auth-1.1.0/src/streamlit_cognito_auth.egg-info/PKG-INFO`
