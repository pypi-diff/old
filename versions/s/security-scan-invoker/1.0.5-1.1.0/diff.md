# Comparing `tmp/security_scan_invoker-1.0.5-py3-none-any.whl.zip` & `tmp/security_scan_invoker-1.1.0-py3-none-any.whl.zip`
...
## Comparing `security_scan_invoker-1.0.5.dist-info/LICENSE` & `security_scan_invoker-1.1.0.dist-info/LICENSE`

 * *Files identical despite different names*

## Comparing `security_scan_invoker-1.0.5.dist-info/METADATA` & `security_scan_invoker-1.1.0.dist-info/METADATA`
...
## Comparing `security_scan_invoker-1.0.5.dist-info/RECORD` & `security_scan_invoker-1.1.0.dist-info/RECORD`
