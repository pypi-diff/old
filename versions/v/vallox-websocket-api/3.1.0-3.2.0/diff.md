# Comparing `tmp/vallox_websocket_api-3.1.0.tar.gz` & `tmp/vallox_websocket_api-3.2.0.tar.gz`
...
### Comparing `vallox_websocket_api-3.1.0/pyproject.toml` & `vallox_websocket_api-3.2.0/pyproject.toml`
