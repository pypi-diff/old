# Comparing `tmp/vpalette-2.1.0.tar.gz` & `tmp/vpalette-3.0.0.tar.gz`
...
## Comparing `vpalette-2.1.0.tar` & `vpalette-3.0.0.tar`
...
### Comparing `vpalette-2.1.0/LICENSE.txt` & `vpalette-3.0.0/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `vpalette-2.1.0/README.md` & `vpalette-3.0.0/README.md`
...
### Comparing `vpalette-2.1.0/pyproject.toml` & `vpalette-3.0.0/pyproject.toml`
...
### Comparing `vpalette-2.1.0/vpalette/colors.py` & `vpalette-3.0.0/vpalette/colors.py`
...
### Comparing `vpalette-2.1.0/PKG-INFO` & `vpalette-3.0.0/PKG-INFO`
