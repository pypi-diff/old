# Comparing `tmp/watchmen_inquiry_surface-16.4.9.tar.gz` & `tmp/watchmen_inquiry_surface-16.5.0.tar.gz`
...
## Comparing `watchmen_inquiry_surface-16.4.9.tar` & `watchmen_inquiry_surface-16.5.0.tar`
...
### Comparing `watchmen_inquiry_surface-16.4.9/LICENSE` & `watchmen_inquiry_surface-16.5.0/LICENSE`

 * *Files identical despite different names*

### Comparing `watchmen_inquiry_surface-16.4.9/pyproject.toml` & `watchmen_inquiry_surface-16.5.0/pyproject.toml`
...
### Comparing `watchmen_inquiry_surface-16.4.9/src/watchmen_inquiry_surface/data/data_router.py` & `watchmen_inquiry_surface-16.5.0/src/watchmen_inquiry_surface/data/data_router.py`

 * *Files identical despite different names*

### Comparing `watchmen_inquiry_surface-16.4.9/PKG-INFO` & `watchmen_inquiry_surface-16.5.0/PKG-INFO`
