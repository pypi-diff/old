# Comparing `tmp/wikirate4py-1.1.4.tar.gz` & `tmp/wikirate4py-1.1.5.tar.gz`
...
### Comparing `wikirate4py-1.1.4/wikirate4py/api.py` & `wikirate4py-1.1.5/wikirate4py/api.py`
