# Comparing `tmp/nerpii-0.1.3.tar.gz` & `tmp/nerpii-0.1.4.tar.gz`
...
## Comparing `nerpii-0.1.3.tar` & `nerpii-0.1.4.tar`
...
### Comparing `nerpii-0.1.3/README.md` & `nerpii-0.1.4/README.md`

 * *Files identical despite different names*

### Comparing `nerpii-0.1.3/nerpii/faker_generator.py` & `nerpii-0.1.4/nerpii/faker_generator.py`
...
### Comparing `nerpii-0.1.3/nerpii/named_entity_recognizer.py` & `nerpii-0.1.4/nerpii/named_entity_recognizer.py`
...
### Comparing `nerpii-0.1.3/pyproject.toml` & `nerpii-0.1.4/pyproject.toml`
...
### Comparing `nerpii-0.1.3/setup.py` & `nerpii-0.1.4/setup.py`
...
### Comparing `nerpii-0.1.3/PKG-INFO` & `nerpii-0.1.4/PKG-INFO`
