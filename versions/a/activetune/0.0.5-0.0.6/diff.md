# Comparing `tmp/activetune-0.0.5.tar.gz` & `tmp/activetune-0.0.6.tar.gz`
...
## Comparing `activetune-0.0.5.tar` & `activetune-0.0.6.tar`
...
### Comparing `activetune-0.0.5/README.md` & `activetune-0.0.6/README.md`

 * *Files identical despite different names*

### Comparing `activetune-0.0.5/activetune/api.py` & `activetune-0.0.6/activetune/api.py`
