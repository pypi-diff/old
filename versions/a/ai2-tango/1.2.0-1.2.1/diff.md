# Comparing `tmp/ai2-tango-1.2.0.tar.gz` & `tmp/ai2-tango-1.2.1.tar.gz`
...
### Comparing `ai2-tango-1.2.0/PKG-INFO` & `ai2-tango-1.2.1/PKG-INFO`
...
### Comparing `ai2-tango-1.2.0/tango/common/testing/steps.py` & `ai2-tango-1.2.1/tango/common/testing/steps.py`
...
### Comparing `ai2-tango-1.2.0/tango/integrations/beaker/step_cache.py` & `ai2-tango-1.2.1/tango/integrations/beaker/step_cache.py`
...
### Comparing `ai2-tango-1.2.0/tango/integrations/fairscale/fsdp_config.py` & `ai2-tango-1.2.1/tango/integrations/fairscale/fsdp_config.py`
...
### Comparing `ai2-tango-1.2.0/tango/integrations/transformers/data.py` & `ai2-tango-1.2.1/tango/integrations/transformers/data.py`

 * *Files identical despite different names*

### Comparing `ai2-tango-1.2.0/tango/integrations/transformers/finetune.py` & `ai2-tango-1.2.1/tango/integrations/transformers/finetune.py`

 * *Files identical despite different names*

### Comparing `ai2-tango-1.2.0/tango/integrations/transformers/ia3.py` & `ai2-tango-1.2.1/tango/integrations/transformers/ia3.py`

 * *Files identical despite different names*

### Comparing `ai2-tango-1.2.0/tango/integrations/transformers/model.py` & `ai2-tango-1.2.1/tango/integrations/transformers/model.py`

 * *Files identical despite different names*

### Comparing `ai2-tango-1.2.0/tango/integrations/transformers/optim.py` & `ai2-tango-1.2.1/tango/integrations/transformers/optim.py`

 * *Files identical despite different names*

### Comparing `ai2-tango-1.2.0/tango/integrations/transformers/run_generation.py` & `ai2-tango-1.2.1/tango/integrations/transformers/run_generation.py`

 * *Files identical despite different names*

### Comparing `ai2-tango-1.2.0/tango/integrations/transformers/soft_prompt.py` & `ai2-tango-1.2.1/tango/integrations/transformers/soft_prompt.py`

 * *Files identical despite different names*

### Comparing `ai2-tango-1.2.0/tango/integrations/transformers/tokenizer.py` & `ai2-tango-1.2.1/tango/integrations/transformers/tokenizer.py`

 * *Files identical despite different names*

### Comparing `ai2-tango-1.2.0/tango/integrations/wandb/__init__.py` & `ai2-tango-1.2.1/tango/integrations/wandb/__init__.py`

 * *Files identical despite different names*

### Comparing `ai2-tango-1.2.0/tango/integrations/wandb/flax_train_callback.py` & `ai2-tango-1.2.1/tango/integrations/wandb/flax_train_callback.py`

 * *Files identical despite different names*

### Comparing `ai2-tango-1.2.0/tango/integrations/wandb/step_cache.py` & `ai2-tango-1.2.1/tango/integrations/wandb/step_cache.py`

 * *Files identical despite different names*

### Comparing `ai2-tango-1.2.0/tango/integrations/wandb/torch_train_callback.py` & `ai2-tango-1.2.1/tango/integrations/wandb/torch_train_callback.py`

 * *Files identical despite different names*

### Comparing `ai2-tango-1.2.0/tango/integrations/wandb/util.py` & `ai2-tango-1.2.1/tango/integrations/wandb/util.py`

 * *Files identical despite different names*

### Comparing `ai2-tango-1.2.0/tango/integrations/wandb/workspace.py` & `ai2-tango-1.2.1/tango/integrations/wandb/workspace.py`

 * *Files identical despite different names*

### Comparing `ai2-tango-1.2.0/tango/settings.py` & `ai2-tango-1.2.1/tango/settings.py`

 * *Files identical despite different names*

### Comparing `ai2-tango-1.2.0/tango/step.py` & `ai2-tango-1.2.1/tango/step.py`
...
### Comparing `ai2-tango-1.2.0/tango/step_cache.py` & `ai2-tango-1.2.1/tango/step_cache.py`

 * *Files identical despite different names*

### Comparing `ai2-tango-1.2.0/tango/step_caches/local_step_cache.py` & `ai2-tango-1.2.1/tango/step_caches/local_step_cache.py`

 * *Files identical despite different names*

### Comparing `ai2-tango-1.2.0/tango/step_caches/memory_step_cache.py` & `ai2-tango-1.2.1/tango/step_caches/memory_step_cache.py`

 * *Files identical despite different names*

### Comparing `ai2-tango-1.2.0/tango/step_caches/remote_step_cache.py` & `ai2-tango-1.2.1/tango/step_caches/remote_step_cache.py`

 * *Files identical despite different names*

### Comparing `ai2-tango-1.2.0/tango/step_graph.py` & `ai2-tango-1.2.1/tango/step_graph.py`

 * *Files identical despite different names*

### Comparing `ai2-tango-1.2.0/tango/step_info.py` & `ai2-tango-1.2.1/tango/step_info.py`
...
### Comparing `ai2-tango-1.2.0/tango/steps/dataset_remix.py` & `ai2-tango-1.2.1/tango/steps/dataset_remix.py`

 * *Files identical despite different names*

### Comparing `ai2-tango-1.2.0/tango/steps/print.py` & `ai2-tango-1.2.1/tango/steps/print.py`

 * *Files identical despite different names*

### Comparing `ai2-tango-1.2.0/tango/steps/shell_step.py` & `ai2-tango-1.2.1/tango/steps/shell_step.py`

 * *Files identical despite different names*

### Comparing `ai2-tango-1.2.0/tango/workspaces/local_workspace.py` & `ai2-tango-1.2.1/tango/workspaces/local_workspace.py`
...
### Comparing `ai2-tango-1.2.0/tango/workspaces/memory_workspace.py` & `ai2-tango-1.2.1/tango/workspaces/memory_workspace.py`
