# Comparing `tmp/QueriPlug-1.0.2.tar.gz` & `tmp/QueriPlug-1.0.3.tar.gz`
...
## Comparing `QueriPlug-1.0.2.tar` & `QueriPlug-1.0.3.tar`
...
### Comparing `QueriPlug-1.0.2/LICENSE` & `QueriPlug-1.0.3/LICENSE`

 * *Files identical despite different names*

### Comparing `QueriPlug-1.0.2/pyproject.toml` & `QueriPlug-1.0.3/pyproject.toml`
...
### Comparing `QueriPlug-1.0.2/src/QueriPlug/connections.py` & `QueriPlug-1.0.3/src/QueriPlug/connections.py`
