# Comparing `tmp/NextionEasy-1.0.tar.gz` & `tmp/NextionEasy-1.1.tar.gz`
...
## Comparing `NextionEasy-1.0.tar` & `NextionEasy-1.1.tar`
...
### Comparing `NextionEasy-1.0/NextionEasy/nextion_easy.py` & `NextionEasy-1.1/NextionEasy/nextion_easy.py`
