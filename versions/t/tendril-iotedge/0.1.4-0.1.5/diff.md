# Comparing `tmp/tendril-iotedge-0.1.4.tar.gz` & `tmp/tendril-iotedge-0.1.5.tar.gz`
...
## Comparing `tendril-iotedge-0.1.4.tar` & `tendril-iotedge-0.1.5.tar`
...
### Comparing `tendril-iotedge-0.1.4/.gitignore` & `tendril-iotedge-0.1.5/.gitignore`

 * *Files identical despite different names*

### Comparing `tendril-iotedge-0.1.4/.readthedocs.yml` & `tendril-iotedge-0.1.5/.readthedocs.yml`

 * *Files identical despite different names*

### Comparing `tendril-iotedge-0.1.4/.travis.yml` & `tendril-iotedge-0.1.5/.travis.yml`

 * *Files identical despite different names*

### Comparing `tendril-iotedge-0.1.4/LICENSE` & `tendril-iotedge-0.1.5/LICENSE`

 * *Files identical despite different names*

### Comparing `tendril-iotedge-0.1.4/PKG-INFO` & `tendril-iotedge-0.1.5/PKG-INFO`
...
### Comparing `tendril-iotedge-0.1.4/README.rst` & `tendril-iotedge-0.1.5/README.rst`

 * *Files identical despite different names*

### Comparing `tendril-iotedge-0.1.4/docs/Makefile` & `tendril-iotedge-0.1.5/docs/Makefile`

 * *Files identical despite different names*

### Comparing `tendril-iotedge-0.1.4/docs/_static/custom.css` & `tendril-iotedge-0.1.5/docs/_static/custom.css`

 * *Files identical despite different names*

### Comparing `tendril-iotedge-0.1.4/docs/_static/favicon.ico` & `tendril-iotedge-0.1.5/docs/_static/favicon.ico`

 * *Files identical despite different names*

### Comparing `tendril-iotedge-0.1.4/docs/_static/logo.png` & `tendril-iotedge-0.1.5/docs/_static/logo.png`

 * *Files identical despite different names*

### Comparing `tendril-iotedge-0.1.4/docs/_static/logo_packed.png` & `tendril-iotedge-0.1.5/docs/_static/logo_packed.png`

 * *Files identical despite different names*

### Comparing `tendril-iotedge-0.1.4/docs/_templates/about.html` & `tendril-iotedge-0.1.5/docs/_templates/about.html`

 * *Files identical despite different names*

### Comparing `tendril-iotedge-0.1.4/docs/conf.py` & `tendril-iotedge-0.1.5/docs/conf.py`

 * *Files identical despite different names*

### Comparing `tendril-iotedge-0.1.4/docs/index.rst` & `tendril-iotedge-0.1.5/docs/index.rst`

 * *Files identical despite different names*

### Comparing `tendril-iotedge-0.1.4/docs/installation.rst` & `tendril-iotedge-0.1.5/docs/installation.rst`

 * *Files identical despite different names*

### Comparing `tendril-iotedge-0.1.4/setup.py` & `tendril-iotedge-0.1.5/setup.py`

 * *Files identical despite different names*

### Comparing `tendril-iotedge-0.1.4/src/tendril/apiserver/routers/iotedge.py` & `tendril-iotedge-0.1.5/src/tendril/apiserver/routers/iotedge.py`
...
### Comparing `tendril-iotedge-0.1.4/src/tendril/common/iotedge/exceptions.py` & `tendril-iotedge-0.1.5/src/tendril/common/iotedge/exceptions.py`

 * *Files identical despite different names*

### Comparing `tendril-iotedge-0.1.4/src/tendril/common/iotedge/formats.py` & `tendril-iotedge-0.1.5/src/tendril/common/iotedge/formats.py`
...
### Comparing `tendril-iotedge-0.1.4/src/tendril/config/__init__.py` & `tendril-iotedge-0.1.5/src/tendril/config/__init__.py`

 * *Files identical despite different names*

### Comparing `tendril-iotedge-0.1.4/src/tendril/config/iotedge.py` & `tendril-iotedge-0.1.5/src/tendril/config/iotedge.py`

 * *Files identical despite different names*

### Comparing `tendril-iotedge-0.1.4/src/tendril/iotedge/announce.py` & `tendril-iotedge-0.1.5/src/tendril/iotedge/announce.py`
...
### Comparing `tendril-iotedge-0.1.4/src/tendril/iotedge/heartbeat.py` & `tendril-iotedge-0.1.5/src/tendril/iotedge/heartbeat.py`
...
### Comparing `tendril-iotedge-0.1.4/src/tendril/iotedge/profiles/base.py` & `tendril-iotedge-0.1.5/src/tendril/iotedge/profiles/base.py`
...
### Comparing `tendril-iotedge-0.1.4/src/tendril/iotedge/profiles/manager.py` & `tendril-iotedge-0.1.5/src/tendril/iotedge/profiles/manager.py`
...
### Comparing `tendril-iotedge-0.1.4/src/tendril/iotedge/registration.py` & `tendril-iotedge-0.1.5/src/tendril/iotedge/registration.py`
...
### Comparing `tendril-iotedge-0.1.4/src/tendril_iotedge.egg-info/PKG-INFO` & `tendril-iotedge-0.1.5/src/tendril_iotedge.egg-info/PKG-INFO`
...
### Comparing `tendril-iotedge-0.1.4/src/tendril_iotedge.egg-info/SOURCES.txt` & `tendril-iotedge-0.1.5/src/tendril_iotedge.egg-info/SOURCES.txt`
...
### Comparing `tendril-iotedge-0.1.4/src/tendril_iotedge.egg-info/requires.txt` & `tendril-iotedge-0.1.5/src/tendril_iotedge.egg-info/requires.txt`

 * *Files identical despite different names*

### Comparing `tendril-iotedge-0.1.4/tests/coveralls.py` & `tendril-iotedge-0.1.5/tests/coveralls.py`

 * *Files identical despite different names*

### Comparing `tendril-iotedge-0.1.4/tox.ini` & `tendril-iotedge-0.1.5/tox.ini`
