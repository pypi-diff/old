# Comparing `tmp/torch-book-0.0.3.tar.gz` & `tmp/torch-book-0.0.5.tar.gz`
...
## Comparing `torch-book-0.0.3.tar` & `torch-book-0.0.5.tar`
...
### Comparing `torch-book-0.0.3/LICENSE` & `torch-book-0.0.5/LICENSE`

 * *Files identical despite different names*

### Comparing `torch-book-0.0.3/README.md` & `torch-book-0.0.5/README.md`
...
### Comparing `torch-book-0.0.3/pyproject.toml` & `torch-book-0.0.5/pyproject.toml`
...
### Comparing `torch-book-0.0.3/src/torch_book/backend/gpu.py` & `torch-book-0.0.5/src/torch_book/backend/gpu.py`

 * *Files identical despite different names*

### Comparing `torch-book-0.0.3/src/torch_book/classifier.py` & `torch-book-0.0.5/src/torch_book/vision/_classifier2.py`
...
### Comparing `torch-book-0.0.3/src/torch_book/data/imagenet.py` & `torch-book-0.0.5/src/torch_book/datasets/imagenet.py`
...
### Comparing `torch-book-0.0.3/src/torch_book/data/simple_vision.py` & `torch-book-0.0.5/src/torch_book/datasets/simple_vision.py`
...
### Comparing `torch-book-0.0.3/PKG-INFO` & `torch-book-0.0.5/PKG-INFO`
