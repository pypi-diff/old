# Comparing `tmp/trbinance-0.1.1.tar.gz` & `tmp/trbinance-0.1.2.tar.gz`
...
## Comparing `trbinance-0.1.1.tar` & `trbinance-0.1.2.tar`
...
### Comparing `trbinance-0.1.1/README.md` & `trbinance-0.1.2/README.md`

 * *Files identical despite different names*

### Comparing `trbinance-0.1.1/trbinance/client.py` & `trbinance-0.1.2/trbinance/client.py`
...
### Comparing `trbinance-0.1.1/trbinance/defines.py` & `trbinance-0.1.2/trbinance/defines.py`

 * *Files identical despite different names*

### Comparing `trbinance-0.1.1/trbinance/helper.py` & `trbinance-0.1.2/trbinance/helper.py`
