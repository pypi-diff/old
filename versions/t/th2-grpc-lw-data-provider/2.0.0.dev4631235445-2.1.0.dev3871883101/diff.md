# Comparing `tmp/th2_grpc_lw_data_provider-2.0.0.dev4631235445.tar.gz` & `tmp/th2_grpc_lw_data_provider-2.1.0.dev3871883101.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dist/th2_grpc_lw_data_provider-2.0.0.dev4631235445.tar", last modified: Thu Apr  6 17:01:14 2023, max compression
...
## Comparing `th2_grpc_lw_data_provider-2.0.0.dev4631235445.tar` & `th2_grpc_lw_data_provider-2.1.0.dev3871883101.tar`

### file list

```diff
@@ -1,25 +1,25 @@
-drwxr-xr-x   0 runner    (1001) docker     (122)        0 2023-04-06 17:01:14.000000 th2_grpc_lw_data_provider-2.0.0.dev4631235445/
--rw-r--r--   0 runner    (1001) docker     (122)      378 2023-04-06 17:01:14.000000 th2_grpc_lw_data_provider-2.0.0.dev4631235445/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (122)       27 2023-04-06 16:59:14.000000 th2_grpc_lw_data_provider-2.0.0.dev4631235445/README.md
--rw-r--r--   0 runner    (1001) docker     (122)       93 2023-04-06 16:59:14.000000 th2_grpc_lw_data_provider-2.0.0.dev4631235445/package_info.json
--rw-r--r--   0 runner    (1001) docker     (122)       38 2023-04-06 17:01:14.000000 th2_grpc_lw_data_provider-2.0.0.dev4631235445/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (122)     4495 2023-04-06 16:59:14.000000 th2_grpc_lw_data_provider-2.0.0.dev4631235445/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (122)        0 2023-04-06 17:01:14.000000 th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider/
--rw-r--r--   0 runner    (1001) docker     (122)        0 2023-04-06 17:01:14.000000 th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider/__init__.py
--rw-r--r--   0 runner    (1001) docker     (122)     1505 2023-04-06 17:00:48.000000 th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider/data_provider_service.py
--rw-r--r--   0 runner    (1001) docker     (122)     8083 2023-04-06 16:59:14.000000 th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider/lw_data_provider.proto
--rw-r--r--   0 runner    (1001) docker     (122)    10841 2023-04-06 17:01:13.000000 th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider/lw_data_provider_pb2.py
--rw-r--r--   0 runner    (1001) docker     (122)    30499 2023-04-06 17:01:13.000000 th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider/lw_data_provider_pb2.pyi
--rw-r--r--   0 runner    (1001) docker     (122)    15651 2023-04-06 17:01:13.000000 th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider/lw_data_provider_pb2_grpc.py
--rw-r--r--   0 runner    (1001) docker     (122)        0 2023-04-06 17:01:14.000000 th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider/py.typed
--rw-r--r--   0 runner    (1001) docker     (122)     2242 2023-04-06 16:59:14.000000 th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider/queue_data_provider.proto
--rw-r--r--   0 runner    (1001) docker     (122)     4891 2023-04-06 17:01:14.000000 th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider/queue_data_provider_pb2.py
--rw-r--r--   0 runner    (1001) docker     (122)    10186 2023-04-06 17:01:14.000000 th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider/queue_data_provider_pb2.pyi
--rw-r--r--   0 runner    (1001) docker     (122)     5036 2023-04-06 17:01:14.000000 th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider/queue_data_provider_pb2_grpc.py
--rw-r--r--   0 runner    (1001) docker     (122)      571 2023-04-06 17:00:48.000000 th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider/queue_data_provider_service.py
-drwxr-xr-x   0 runner    (1001) docker     (122)        0 2023-04-06 17:01:14.000000 th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider.egg-info/
--rw-r--r--   0 runner    (1001) docker     (122)      378 2023-04-06 17:01:14.000000 th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (122)      883 2023-04-06 17:01:14.000000 th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (122)        1 2023-04-06 17:01:14.000000 th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (122)       22 2023-04-06 17:01:14.000000 th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (122)       27 2023-04-06 17:01:14.000000 th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider.egg-info/top_level.txt
...
### Comparing `th2_grpc_lw_data_provider-2.0.0.dev4631235445/setup.py` & `th2_grpc_lw_data_provider-2.1.0.dev3871883101/setup.py`
...
### Comparing `th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider/data_provider_service.py` & `th2_grpc_lw_data_provider-2.1.0.dev3871883101/th2_grpc_lw_data_provider/data_provider_service.py`
...
### Comparing `th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider/lw_data_provider.proto` & `th2_grpc_lw_data_provider-2.1.0.dev3871883101/th2_grpc_lw_data_provider/lw_data_provider.proto`
...
### Comparing `th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider/lw_data_provider_pb2.py` & `th2_grpc_lw_data_provider-2.1.0.dev3871883101/th2_grpc_lw_data_provider/lw_data_provider_pb2.py`
...
-  _TIMERELATION._serialized_start=3841
-  _TIMERELATION._serialized_end=3879
...
-  _MESSAGEGROUPSSEARCHREQUEST._serialized_end=635
-  _MESSAGEGROUPSSEARCHREQUEST_GROUP._serialized_start=614
-  _MESSAGEGROUPSSEARCHREQUEST_GROUP._serialized_end=635
-  _MESSAGESTREAMSREQUEST._serialized_start=637
-  _MESSAGESTREAMSREQUEST._serialized_end=707
-  _EVENTRESPONSE._serialized_start=710
-  _EVENTRESPONSE._serialized_end=1065
-  _MESSAGEGROUPITEM._serialized_start=1067
-  _MESSAGEGROUPITEM._serialized_end=1127
-  _MESSAGEGROUPRESPONSE._serialized_start=1130
-  _MESSAGEGROUPRESPONSE._serialized_end=1505
-  _MESSAGEGROUPRESPONSE_MESSAGEPROPERTIESENTRY._serialized_start=1449
-  _MESSAGEGROUPRESPONSE_MESSAGEPROPERTIESENTRY._serialized_end=1505
-  _FILTERNAME._serialized_start=1507
-  _FILTERNAME._serialized_end=1533
-  _FILTER._serialized_start=1535
-  _FILTER._serialized_end=1642
-  _EVENTSEARCHREQUEST._serialized_start=1645
-  _EVENTSEARCHREQUEST._serialized_end=2062
-  _EVENTSEARCHRESPONSE._serialized_start=2064
-  _EVENTSEARCHRESPONSE._serialized_end=2147
-  _MESSAGESEARCHREQUEST._serialized_start=2150
-  _MESSAGESEARCHREQUEST._serialized_end=2636
-  _MESSAGESEARCHRESPONSE._serialized_start=2639
-  _MESSAGESEARCHRESPONSE._serialized_end=2813
-  _MESSAGESTREAMPOINTERS._serialized_start=2815
-  _MESSAGESTREAMPOINTERS._serialized_end=2914
-  _MESSAGESTREAMPOINTER._serialized_start=2916
-  _MESSAGESTREAMPOINTER._serialized_end=3028
-  _MESSAGESTREAM._serialized_start=3030
-  _MESSAGESTREAM._serialized_end=3090
-  _MESSAGESTREAMSRESPONSE._serialized_start=3092
-  _MESSAGESTREAMSRESPONSE._serialized_end=3177
-  _BOOKSREQUEST._serialized_start=3179
-  _BOOKSREQUEST._serialized_end=3193
-  _BOOKSRESPONSE._serialized_start=3195
-  _BOOKSRESPONSE._serialized_end=3258
-  _PAGEINFOREQUEST._serialized_start=3261
-  _PAGEINFOREQUEST._serialized_end=3480
-  _PAGEINFORESPONSE._serialized_start=3483
-  _PAGEINFORESPONSE._serialized_end=3768
-  _PAGEID._serialized_start=3770
-  _PAGEID._serialized_end=3839
-  _DATAPROVIDER._serialized_start=3882
-  _DATAPROVIDER._serialized_end=4650
...
### Comparing `th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider/lw_data_provider_pb2.pyi` & `th2_grpc_lw_data_provider-2.1.0.dev3871883101/th2_grpc_lw_data_provider/lw_data_provider_pb2.pyi`
...
### Comparing `th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider/lw_data_provider_pb2_grpc.py` & `th2_grpc_lw_data_provider-2.1.0.dev3871883101/th2_grpc_lw_data_provider/lw_data_provider_pb2_grpc.py`
...
### Comparing `th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider/queue_data_provider.proto` & `th2_grpc_lw_data_provider-2.1.0.dev3871883101/th2_grpc_lw_data_provider/queue_data_provider.proto`

 * *Files identical despite different names*

### Comparing `th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider/queue_data_provider_pb2.py` & `th2_grpc_lw_data_provider-2.1.0.dev3871883101/th2_grpc_lw_data_provider/queue_data_provider_pb2.py`

 * *Files identical despite different names*

### Comparing `th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider/queue_data_provider_pb2.pyi` & `th2_grpc_lw_data_provider-2.1.0.dev3871883101/th2_grpc_lw_data_provider/queue_data_provider_pb2.pyi`

 * *Files identical despite different names*

### Comparing `th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider/queue_data_provider_pb2_grpc.py` & `th2_grpc_lw_data_provider-2.1.0.dev3871883101/th2_grpc_lw_data_provider/queue_data_provider_pb2_grpc.py`

 * *Files identical despite different names*

### Comparing `th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider/queue_data_provider_service.py` & `th2_grpc_lw_data_provider-2.1.0.dev3871883101/th2_grpc_lw_data_provider/queue_data_provider_service.py`

 * *Files identical despite different names*

### Comparing `th2_grpc_lw_data_provider-2.0.0.dev4631235445/th2_grpc_lw_data_provider.egg-info/SOURCES.txt` & `th2_grpc_lw_data_provider-2.1.0.dev3871883101/th2_grpc_lw_data_provider.egg-info/SOURCES.txt`
