# Comparing `tmp/tap-pendo-0.6.0.tar.gz` & `tmp/tap-pendo-0.6.1.tar.gz`
...
### Comparing `tap-pendo-0.6.0/tap_pendo/schemas/track_events.json` & `tap-pendo-0.6.1/tap_pendo/schemas/track_events.json`
