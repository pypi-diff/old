# Comparing `tmp/cyxmltv-0.3.tar.gz` & `tmp/cyxmltv-0.4.1.tar.gz`
...
## Comparing `cyxmltv-0.3.tar` & `cyxmltv-0.4.1.tar`
...
### Comparing `cyxmltv-0.3/PKG-INFO` & `cyxmltv-0.4.1/PKG-INFO`
...
### Comparing `cyxmltv-0.3/README.md` & `cyxmltv-0.4.1/README.md`
...
### Comparing `cyxmltv-0.3/cyxmltv/parser.py` & `cyxmltv-0.4.1/cyxmltv/parser.py`
...
### Comparing `cyxmltv-0.3/cyxmltv/xmltv.py` & `cyxmltv-0.4.1/cyxmltv/xmltv.py`
...
### Comparing `cyxmltv-0.3/cyxmltv.egg-info/PKG-INFO` & `cyxmltv-0.4.1/cyxmltv.egg-info/PKG-INFO`
