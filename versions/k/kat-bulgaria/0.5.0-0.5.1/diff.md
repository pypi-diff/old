# Comparing `tmp/kat_bulgaria-0.5.0.tar.gz` & `tmp/kat_bulgaria-0.5.1.tar.gz`
...
## Comparing `kat_bulgaria-0.5.0.tar` & `kat_bulgaria-0.5.1.tar`
...
### Comparing `kat_bulgaria-0.5.0/PKG-INFO` & `kat_bulgaria-0.5.1/PKG-INFO`
...
### Comparing `kat_bulgaria-0.5.0/README.md` & `kat_bulgaria-0.5.1/README.md`

 * *Files identical despite different names*

### Comparing `kat_bulgaria-0.5.0/kat_bulgaria/obligations.py` & `kat_bulgaria-0.5.1/kat_bulgaria/obligations.py`
...
### Comparing `kat_bulgaria-0.5.0/kat_bulgaria.egg-info/PKG-INFO` & `kat_bulgaria-0.5.1/kat_bulgaria.egg-info/PKG-INFO`
...
### Comparing `kat_bulgaria-0.5.0/setup.py` & `kat_bulgaria-0.5.1/setup.py`
