# Comparing `tmp/kittycad-0.3.4.tar.gz` & `tmp/kittycad-0.3.5.tar.gz`
...
### Comparing `kittycad-0.3.4/kittycad/api/api_calls/get_async_operation.py` & `kittycad-0.3.5/kittycad/api/file/get_file_conversion.py`
...
### Comparing `kittycad-0.3.4/kittycad/api/api_calls/list_api_calls.py` & `kittycad-0.3.5/kittycad/api/api_calls/list_api_calls.py`
...
### Comparing `kittycad-0.3.4/kittycad/api/file/create_file_center_of_mass_with_uniform_density.py` & `kittycad-0.3.5/kittycad/api/file/create_file_surface_area.py`
...
### Comparing `kittycad-0.3.4/kittycad/api/file/create_file_conversion.py` & `kittycad-0.3.5/kittycad/api/file/create_file_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/file/create_file_conversion_with_base64_helper.py` & `kittycad-0.3.5/kittycad/api/file/create_file_conversion_with_base64_helper.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/file/create_file_density.py` & `kittycad-0.3.5/kittycad/api/file/create_file_density.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/file/create_file_execution.py` & `kittycad-0.3.5/kittycad/api/file/create_file_execution.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/file/create_file_mass.py` & `kittycad-0.3.5/kittycad/api/file/create_file_center_of_mass.py`
...
### Comparing `kittycad-0.3.4/kittycad/api/file/create_file_surface_area.py` & `kittycad-0.3.5/kittycad/api/file/create_file_volume.py`
...
### Comparing `kittycad-0.3.4/kittycad/api/file/create_file_volume.py` & `kittycad-0.3.5/kittycad/api/users/get_user_extended.py`
...
### Comparing `kittycad-0.3.4/kittycad/api/file/get_file_conversion.py` & `kittycad-0.3.5/kittycad/api/file/get_file_conversion_for_user.py`
...
### Comparing `kittycad-0.3.4/kittycad/api/file/get_file_conversion_for_user.py` & `kittycad-0.3.5/kittycad/api/api_calls/get_async_operation.py`
...
### Comparing `kittycad-0.3.4/kittycad/api/file/get_file_conversion_with_base64_helper.py` & `kittycad-0.3.5/kittycad/api/file/get_file_conversion_with_base64_helper.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/hidden/auth_email.py` & `kittycad-0.3.5/kittycad/api/hidden/auth_email.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/hidden/auth_email_callback.py` & `kittycad-0.3.5/kittycad/api/hidden/auth_email_callback.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/hidden/logout.py` & `kittycad-0.3.5/kittycad/api/hidden/logout.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/meta/get_metadata.py` & `kittycad-0.3.5/kittycad/api/meta/get_metadata.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/meta/get_schema.py` & `kittycad-0.3.5/kittycad/api/meta/get_schema.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/meta/ping.py` & `kittycad-0.3.5/kittycad/api/meta/ping.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/payments/create_payment_information_for_user.py` & `kittycad-0.3.5/kittycad/api/payments/create_payment_information_for_user.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/payments/create_payment_intent_for_user.py` & `kittycad-0.3.5/kittycad/api/payments/create_payment_intent_for_user.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/payments/delete_payment_information_for_user.py` & `kittycad-0.3.5/kittycad/api/payments/delete_payment_information_for_user.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/payments/delete_payment_method_for_user.py` & `kittycad-0.3.5/kittycad/api/payments/delete_payment_method_for_user.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/payments/get_payment_balance_for_user.py` & `kittycad-0.3.5/kittycad/api/payments/get_payment_balance_for_user.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/payments/get_payment_information_for_user.py` & `kittycad-0.3.5/kittycad/api/payments/get_payment_information_for_user.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/payments/list_invoices_for_user.py` & `kittycad-0.3.5/kittycad/api/payments/list_invoices_for_user.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/payments/list_payment_methods_for_user.py` & `kittycad-0.3.5/kittycad/api/payments/list_payment_methods_for_user.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/payments/update_payment_information_for_user.py` & `kittycad-0.3.5/kittycad/api/payments/update_payment_information_for_user.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/sessions/get_session_for_user.py` & `kittycad-0.3.5/kittycad/api/sessions/get_session_for_user.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_acceleration_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_acceleration_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_angle_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_angle_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_angular_velocity_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_angular_velocity_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_area_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_area_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_charge_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_charge_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_concentration_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_concentration_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_data_transfer_rate_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_data_transfer_rate_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_data_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_data_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_density_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_density_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_energy_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_energy_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_force_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_force_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_illuminance_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_illuminance_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_length_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_length_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_magnetic_field_strength_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_magnetic_field_strength_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_magnetic_flux_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_magnetic_flux_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_mass_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_mass_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_metric_power_cubed_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_metric_power_cubed_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_metric_power_squared_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_metric_power_squared_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_metric_power_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_metric_power_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_power_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_power_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_pressure_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_pressure_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_radiation_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_radiation_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_radioactivity_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_radioactivity_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_solid_angle_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_solid_angle_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_temperature_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_temperature_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_time_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_time_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_velocity_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_velocity_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_voltage_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_voltage_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/unit/get_volume_unit_conversion.py` & `kittycad-0.3.5/kittycad/api/unit/get_volume_unit_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/users/delete_user_self.py` & `kittycad-0.3.5/kittycad/api/users/delete_user_self.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/users/get_user.py` & `kittycad-0.3.5/kittycad/api/users/get_user.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/users/get_user_extended.py` & `kittycad-0.3.5/kittycad/api/users/update_user_self.py`
...
### Comparing `kittycad-0.3.4/kittycad/api/users/get_user_front_hash_self.py` & `kittycad-0.3.5/kittycad/api/users/get_user_front_hash_self.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/users/get_user_onboarding_self.py` & `kittycad-0.3.5/kittycad/api/users/get_user_onboarding_self.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/users/get_user_self.py` & `kittycad-0.3.5/kittycad/api/users/get_user_self.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/users/get_user_self_extended.py` & `kittycad-0.3.5/kittycad/api/users/get_user_self_extended.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/users/list_users.py` & `kittycad-0.3.5/kittycad/api/users/list_users.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/users/list_users_extended.py` & `kittycad-0.3.5/kittycad/api/users/list_users_extended.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/api/users/update_user_self.py` & `kittycad-0.3.5/kittycad/api/meta/get_ai_plugin_manifest.py`
...
### Comparing `kittycad-0.3.4/kittycad/client.py` & `kittycad-0.3.5/kittycad/client.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/client_test.py` & `kittycad-0.3.5/kittycad/client_test.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/__init__.py` & `kittycad-0.3.5/kittycad/models/__init__.py`
...
### Comparing `kittycad-0.3.4/kittycad/models/api_call_query_group.py` & `kittycad-0.3.5/kittycad/models/api_call_query_group.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/api_call_with_price.py` & `kittycad-0.3.5/kittycad/models/api_call_with_price.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/api_call_with_price_results_page.py` & `kittycad-0.3.5/kittycad/models/api_call_with_price_results_page.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/api_token.py` & `kittycad-0.3.5/kittycad/models/api_token.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/api_token_results_page.py` & `kittycad-0.3.5/kittycad/models/api_token_results_page.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/app_client_info.py` & `kittycad-0.3.5/kittycad/models/app_client_info.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/async_api_call.py` & `kittycad-0.3.5/kittycad/models/async_api_call.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/async_api_call_results_page.py` & `kittycad-0.3.5/kittycad/models/async_api_call_results_page.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/billing_info.py` & `kittycad-0.3.5/kittycad/models/billing_info.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/cache_metadata.py` & `kittycad-0.3.5/kittycad/models/cache_metadata.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/card_details.py` & `kittycad-0.3.5/kittycad/models/card_details.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/cluster.py` & `kittycad-0.3.5/kittycad/models/cluster.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/code_output.py` & `kittycad-0.3.5/kittycad/models/code_output.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/commit.py` & `kittycad-0.3.5/kittycad/models/commit.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/connection.py` & `kittycad-0.3.5/kittycad/models/connection.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/currency.py` & `kittycad-0.3.5/kittycad/models/currency.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/customer.py` & `kittycad-0.3.5/kittycad/models/customer.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/customer_balance.py` & `kittycad-0.3.5/kittycad/models/customer_balance.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/device_access_token_request_form.py` & `kittycad-0.3.5/kittycad/models/device_access_token_request_form.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/device_auth_request_form.py` & `kittycad-0.3.5/kittycad/models/device_auth_request_form.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/device_auth_verify_params.py` & `kittycad-0.3.5/kittycad/models/device_auth_verify_params.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/docker_system_info.py` & `kittycad-0.3.5/kittycad/models/docker_system_info.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/email_authentication_form.py` & `kittycad-0.3.5/kittycad/models/email_authentication_form.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/engine_metadata.py` & `kittycad-0.3.5/kittycad/models/engine_metadata.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/error.py` & `kittycad-0.3.5/kittycad/models/error.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/executor_metadata.py` & `kittycad-0.3.5/kittycad/models/executor_metadata.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/extended_user.py` & `kittycad-0.3.5/kittycad/models/extended_user.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/extended_user_results_page.py` & `kittycad-0.3.5/kittycad/models/extended_user_results_page.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/file2_d_vector_conversion.py` & `kittycad-0.3.5/kittycad/models/file2_d_vector_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/file3_d_conversion.py` & `kittycad-0.3.5/kittycad/models/file3_d_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/file_center_of_mass.py` & `kittycad-0.3.5/kittycad/models/file_center_of_mass.py`
...
### Comparing `kittycad-0.3.4/kittycad/models/file_center_of_mass_with_uniform_density.py` & `kittycad-0.3.5/kittycad/models/file_volume.py`
...
### Comparing `kittycad-0.3.4/kittycad/models/file_conversion.py` & `kittycad-0.3.5/kittycad/models/file_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/file_density.py` & `kittycad-0.3.5/kittycad/models/file_density.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/file_mass.py` & `kittycad-0.3.5/kittycad/models/file_mass.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/file_surface_area.py` & `kittycad-0.3.5/kittycad/models/file_surface_area.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/file_system_metadata.py` & `kittycad-0.3.5/kittycad/models/file_system_metadata.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/file_volume.py` & `kittycad-0.3.5/kittycad/models/physics_constant.py`
...
### Comparing `kittycad-0.3.4/kittycad/models/gateway.py` & `kittycad-0.3.5/kittycad/models/gateway.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/index_info.py` & `kittycad-0.3.5/kittycad/models/index_info.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/invoice.py` & `kittycad-0.3.5/kittycad/models/invoice.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/invoice_line_item.py` & `kittycad-0.3.5/kittycad/models/invoice_line_item.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/jetstream.py` & `kittycad-0.3.5/kittycad/models/jetstream.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/jetstream_api_stats.py` & `kittycad-0.3.5/kittycad/models/jetstream_api_stats.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/jetstream_config.py` & `kittycad-0.3.5/kittycad/models/jetstream_config.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/jetstream_stats.py` & `kittycad-0.3.5/kittycad/models/jetstream_stats.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/leaf_node.py` & `kittycad-0.3.5/kittycad/models/leaf_node.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/mesh.py` & `kittycad-0.3.5/kittycad/models/mesh.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/meta_cluster_info.py` & `kittycad-0.3.5/kittycad/models/meta_cluster_info.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/metadata.py` & `kittycad-0.3.5/kittycad/models/metadata.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/new_address.py` & `kittycad-0.3.5/kittycad/models/new_address.py`
...
### Comparing `kittycad-0.3.4/kittycad/models/o_auth2_client_info.py` & `kittycad-0.3.5/kittycad/models/o_auth2_client_info.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/onboarding.py` & `kittycad-0.3.5/kittycad/models/onboarding.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/output_file.py` & `kittycad-0.3.5/kittycad/models/output_file.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/payment_intent.py` & `kittycad-0.3.5/kittycad/models/payment_intent.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/payment_method.py` & `kittycad-0.3.5/kittycad/models/payment_method.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/payment_method_card_checks.py` & `kittycad-0.3.5/kittycad/models/payment_method_card_checks.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/physics_constant.py` & `kittycad-0.3.5/kittycad/models/unit_energy_conversion.py`
...
### Comparing `kittycad-0.3.4/kittycad/models/physics_constant_name.py` & `kittycad-0.3.5/kittycad/models/physics_constant_name.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/plugins_info.py` & `kittycad-0.3.5/kittycad/models/plugins_info.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/point_e_metadata.py` & `kittycad-0.3.5/kittycad/models/point_e_metadata.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/pong.py` & `kittycad-0.3.5/kittycad/models/pong.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/registry_service_config.py` & `kittycad-0.3.5/kittycad/models/registry_service_config.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/runtime.py` & `kittycad-0.3.5/kittycad/models/runtime.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/session.py` & `kittycad-0.3.5/kittycad/models/session.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/system_info_default_address_pools.py` & `kittycad-0.3.5/kittycad/models/system_info_default_address_pools.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_acceleration_conversion.py` & `kittycad-0.3.5/kittycad/models/unit_acceleration_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_angle_conversion.py` & `kittycad-0.3.5/kittycad/models/unit_angle_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_angular_velocity_conversion.py` & `kittycad-0.3.5/kittycad/models/unit_angular_velocity_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_area_conversion.py` & `kittycad-0.3.5/kittycad/models/unit_area_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_charge_conversion.py` & `kittycad-0.3.5/kittycad/models/unit_charge_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_concentration_conversion.py` & `kittycad-0.3.5/kittycad/models/unit_concentration_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_data_conversion.py` & `kittycad-0.3.5/kittycad/models/unit_data_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_data_transfer_rate_conversion.py` & `kittycad-0.3.5/kittycad/models/unit_data_transfer_rate_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_density_conversion.py` & `kittycad-0.3.5/kittycad/models/unit_density_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_density_format.py` & `kittycad-0.3.5/kittycad/models/unit_density_format.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_energy_conversion.py` & `kittycad-0.3.5/kittycad/models/unit_velocity_conversion.py`
...
### Comparing `kittycad-0.3.4/kittycad/models/unit_force_conversion.py` & `kittycad-0.3.5/kittycad/models/unit_force_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_illuminance_conversion.py` & `kittycad-0.3.5/kittycad/models/unit_illuminance_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_length_conversion.py` & `kittycad-0.3.5/kittycad/models/unit_length_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_length_format.py` & `kittycad-0.3.5/kittycad/models/unit_length_format.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_magnetic_field_strength_conversion.py` & `kittycad-0.3.5/kittycad/models/unit_magnetic_field_strength_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_magnetic_flux_conversion.py` & `kittycad-0.3.5/kittycad/models/unit_magnetic_flux_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_mass_conversion.py` & `kittycad-0.3.5/kittycad/models/unit_mass_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_metric_power_conversion.py` & `kittycad-0.3.5/kittycad/models/unit_metric_power_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_metric_power_cubed_conversion.py` & `kittycad-0.3.5/kittycad/models/unit_metric_power_cubed_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_metric_power_squared_conversion.py` & `kittycad-0.3.5/kittycad/models/unit_metric_power_squared_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_power_conversion.py` & `kittycad-0.3.5/kittycad/models/unit_power_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_pressure_conversion.py` & `kittycad-0.3.5/kittycad/models/unit_pressure_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_radiation_conversion.py` & `kittycad-0.3.5/kittycad/models/unit_radiation_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_radioactivity_conversion.py` & `kittycad-0.3.5/kittycad/models/unit_radioactivity_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_solid_angle_conversion.py` & `kittycad-0.3.5/kittycad/models/unit_solid_angle_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_temperature_conversion.py` & `kittycad-0.3.5/kittycad/models/unit_temperature_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_time_conversion.py` & `kittycad-0.3.5/kittycad/models/unit_time_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_velocity_conversion.py` & `kittycad-0.3.5/kittycad/models/unit_volume_conversion.py`
...
### Comparing `kittycad-0.3.4/kittycad/models/unit_voltage_conversion.py` & `kittycad-0.3.5/kittycad/models/unit_voltage_conversion.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/unit_volume_format.py` & `kittycad-0.3.5/kittycad/models/unit_volume_format.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/update_user.py` & `kittycad-0.3.5/kittycad/models/update_user.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/user.py` & `kittycad-0.3.5/kittycad/models/user.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/user_results_page.py` & `kittycad-0.3.5/kittycad/models/user_results_page.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/models/verification_token.py` & `kittycad-0.3.5/kittycad/models/verification_token.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/kittycad/types.py` & `kittycad-0.3.5/kittycad/types.py`

 * *Files identical despite different names*

### Comparing `kittycad-0.3.4/pyproject.toml` & `kittycad-0.3.5/pyproject.toml`
...
### Comparing `kittycad-0.3.4/PKG-INFO` & `kittycad-0.3.5/PKG-INFO`
