# Comparing `tmp/kinms_fitter-0.4.6.tar.gz` & `tmp/kinms_fitter-0.4.7.tar.gz`
...
## Comparing `kinms_fitter-0.4.6.tar` & `kinms_fitter-0.4.7.tar`
...
### Comparing `kinms_fitter-0.4.6/kinms_fitter/kinms_fitter.py` & `kinms_fitter-0.4.7/kinms_fitter/kinms_fitter.py`
...
### Comparing `kinms_fitter-0.4.6/kinms_fitter/kinms_fitter_old.py` & `kinms_fitter-0.4.7/kinms_fitter/kinms_fitter_old.py`

 * *Files identical despite different names*

### Comparing `kinms_fitter-0.4.6/kinms_fitter/prior_funcs.py` & `kinms_fitter-0.4.7/kinms_fitter/prior_funcs.py`

 * *Files identical despite different names*

### Comparing `kinms_fitter-0.4.6/kinms_fitter/transformClouds.py` & `kinms_fitter-0.4.7/kinms_fitter/transformClouds.py`

 * *Files identical despite different names*

### Comparing `kinms_fitter-0.4.6/kinms_fitter/velocity_profs.py` & `kinms_fitter-0.4.7/kinms_fitter/velocity_profs.py`
...
### Comparing `kinms_fitter-0.4.6/kinms_fitter/warp_funcs.py` & `kinms_fitter-0.4.7/kinms_fitter/warp_funcs.py`

 * *Files identical despite different names*

### Comparing `kinms_fitter-0.4.6/setup.py` & `kinms_fitter-0.4.7/setup.py`
