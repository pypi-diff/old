# Comparing `tmp/dassana-0.8.2.tar.gz` & `tmp/dassana-0.8.3.tar.gz`
...
## Comparing `dassana-0.8.2.tar` & `dassana-0.8.3.tar`
...
### Comparing `dassana-0.8.2/dassana/dassana_env.py` & `dassana-0.8.3/dassana/dassana_env.py`
...
### Comparing `dassana-0.8.2/dassana/data_pipes.py` & `dassana-0.8.3/dassana/data_pipes.py`

 * *Files identical despite different names*

### Comparing `dassana-0.8.2/dassana/rest.py` & `dassana-0.8.3/dassana/rest.py`
