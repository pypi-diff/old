# Comparing `tmp/durin-0.0.73.tar.gz` & `tmp/durin-0.0.74.tar.gz`
...
## Comparing `durin-0.0.73.tar` & `durin-0.0.74.tar`
...
### Comparing `durin-0.0.73/PKG-INFO` & `durin-0.0.74/PKG-INFO`
...
### Comparing `durin-0.0.73/README.md` & `durin-0.0.74/README.md`

 * *Files identical despite different names*

### Comparing `durin-0.0.73/durin/actuator.py` & `durin-0.0.74/durin/actuator.py`

 * *Files identical despite different names*

### Comparing `durin-0.0.73/durin/cli.py` & `durin-0.0.74/durin/cli.py`

 * *Files identical despite different names*

### Comparing `durin-0.0.73/durin/controller/server.py` & `durin-0.0.74/durin/controller/server.py`

 * *Files identical despite different names*

### Comparing `durin-0.0.73/durin/controller/test/test_stream.py` & `durin-0.0.74/durin/controller/test/test_stream.py`

 * *Files identical despite different names*

### Comparing `durin-0.0.73/durin/durin.py` & `durin-0.0.74/durin/durin.py`

 * *Files identical despite different names*

### Comparing `durin-0.0.73/durin/durin_birdseye.jpg` & `durin-0.0.74/durin/durin_birdseye.jpg`

 * *Files identical despite different names*

### Comparing `durin-0.0.73/durin/examples/braitenberg.py` & `durin-0.0.74/durin/examples/braitenberg.py`

 * *Files identical despite different names*

### Comparing `durin-0.0.73/durin/examples/commands.py` & `durin-0.0.74/durin/examples/commands.py`

 * *Files identical despite different names*

### Comparing `durin-0.0.73/durin/examples/dashboard.py` & `durin-0.0.74/durin/examples/dashboard.py`

 * *Files identical despite different names*

### Comparing `durin-0.0.73/durin/examples/main.py` & `durin-0.0.74/durin/examples/main.py`

 * *Files identical despite different names*

### Comparing `durin-0.0.73/durin/examples/record.py` & `durin-0.0.74/durin/examples/record.py`

 * *Files identical despite different names*

### Comparing `durin-0.0.73/durin/examples/stats.py` & `durin-0.0.74/durin/examples/stats.py`

 * *Files identical despite different names*

### Comparing `durin-0.0.73/durin/io/__init__.py` & `durin-0.0.74/durin/io/__init__.py`

 * *Files identical despite different names*

### Comparing `durin-0.0.73/durin/io/command.py` & `durin-0.0.74/durin/io/command.py`
...
### Comparing `durin-0.0.73/durin/io/gamepad.py` & `durin-0.0.74/durin/io/gamepad.py`

 * *Files identical despite different names*

### Comparing `durin-0.0.73/durin/io/network.py` & `durin-0.0.74/durin/io/network.py`

 * *Files identical despite different names*

### Comparing `durin-0.0.73/durin/io/ringbuffer.py` & `durin-0.0.74/durin/io/ringbuffer.py`

 * *Files identical despite different names*

### Comparing `durin-0.0.73/durin/io/runnable.py` & `durin-0.0.74/durin/io/runnable.py`

 * *Files identical despite different names*

### Comparing `durin-0.0.73/durin/io/schema.capnp` & `durin-0.0.74/durin/io/schema.capnp`
...
### Comparing `durin-0.0.73/durin/sensor.py` & `durin-0.0.74/durin/sensor.py`
...
### Comparing `durin-0.0.73/durin/ui.py` & `durin-0.0.74/durin/ui.py`
...
### Comparing `durin-0.0.73/durin.egg-info/PKG-INFO` & `durin-0.0.74/durin.egg-info/PKG-INFO`
...
### Comparing `durin-0.0.73/durin.egg-info/SOURCES.txt` & `durin-0.0.74/durin.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `durin-0.0.73/setup.py` & `durin-0.0.74/setup.py`
