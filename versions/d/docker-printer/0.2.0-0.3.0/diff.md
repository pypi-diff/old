# Comparing `tmp/docker-printer-0.2.0.tar.gz` & `tmp/docker-printer-0.3.0.tar.gz`
...
## Comparing `docker-printer-0.2.0.tar` & `docker-printer-0.3.0.tar`
...
### Comparing `docker-printer-0.2.0/PKG-INFO` & `docker-printer-0.3.0/README.md`
...
### Comparing `docker-printer-0.2.0/README.md` & `docker-printer-0.3.0/PKG-INFO`
...
### Comparing `docker-printer-0.2.0/docker_printer/models.py` & `docker-printer-0.3.0/docker_printer/models.py`
...
### Comparing `docker-printer-0.2.0/docker_printer/resources/templates/stage.Dockerfile.jinja2` & `docker-printer-0.3.0/docker_printer/resources/templates/stage.Dockerfile.jinja2`

 * *Files identical despite different names*

### Comparing `docker-printer-0.2.0/docker_printer/utils.py` & `docker-printer-0.3.0/docker_printer/utils.py`
...
### Comparing `docker-printer-0.2.0/setup.cfg` & `docker-printer-0.3.0/setup.cfg`
