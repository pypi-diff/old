# Comparing `tmp/directory_healthcheck-3.0.3-py3-none-any.whl.zip` & `tmp/directory_healthcheck-3.0.4-py3-none-any.whl.zip`
...
## Comparing `directory_healthcheck-3.0.3.dist-info/LICENSE` & `directory_healthcheck-3.0.4.dist-info/LICENSE`

 * *Files identical despite different names*

## Comparing `directory_healthcheck-3.0.3.dist-info/METADATA` & `directory_healthcheck-3.0.4.dist-info/METADATA`
...
## Comparing `directory_healthcheck-3.0.3.dist-info/RECORD` & `directory_healthcheck-3.0.4.dist-info/RECORD`
