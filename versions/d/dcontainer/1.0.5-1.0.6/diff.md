# Comparing `tmp/dcontainer-1.0.5-py3-none-any.whl.zip` & `tmp/dcontainer-1.0.6-py3-none-any.whl.zip`

## zipinfo {}

```diff
@@ -1,30 +1,31 @@
-Zip file size: 16010 bytes, number of entries: 28
--rw-r--r--  2.0 unx        0 b- defN 23-Apr-01 23:42 dcontainer/__init__.py
--rw-r--r--  2.0 unx      662 b- defN 23-Apr-01 23:42 dcontainer/__main__.py
--rw-r--r--  2.0 unx        0 b- defN 23-Apr-01 23:42 dcontainer/py.typed
--rw-r--r--  2.0 unx        0 b- defN 23-Apr-01 23:42 dcontainer/cli/__init__.py
--rw-r--r--  2.0 unx      685 b- defN 23-Apr-01 23:42 dcontainer/cli/generate.py
--rw-r--r--  2.0 unx        0 b- defN 23-Apr-01 23:42 dcontainer/devcontainer/__init__.py
--rw-r--r--  2.0 unx        0 b- defN 23-Apr-01 23:42 dcontainer/devcontainer/feature_generation/__init__.py
--rw-r--r--  2.0 unx     1056 b- defN 23-Apr-01 23:42 dcontainer/devcontainer/feature_generation/oci_feature_generator.py
--rw-r--r--  2.0 unx        0 b- defN 23-Apr-01 23:42 dcontainer/devcontainer/feature_generation/dir_models/__init__.py
--rw-r--r--  2.0 unx     1303 b- defN 23-Apr-01 23:42 dcontainer/devcontainer/feature_generation/dir_models/src_dir.py
--rw-r--r--  2.0 unx      982 b- defN 23-Apr-01 23:42 dcontainer/devcontainer/feature_generation/dir_models/test_dir.py
--rw-r--r--  2.0 unx        0 b- defN 23-Apr-01 23:42 dcontainer/devcontainer/feature_generation/file_models/__init__.py
--rw-r--r--  2.0 unx      388 b- defN 23-Apr-01 23:42 dcontainer/devcontainer/feature_generation/file_models/devcontainer_feature_json.py
--rw-r--r--  2.0 unx     3608 b- defN 23-Apr-01 23:42 dcontainer/devcontainer/feature_generation/file_models/install_sh.py
--rw-r--r--  2.0 unx     5999 b- defN 23-Apr-01 23:42 dcontainer/devcontainer/feature_generation/file_models/library_scripts_sh.py
--rw-r--r--  2.0 unx      577 b- defN 23-Apr-01 23:42 dcontainer/devcontainer/feature_generation/file_models/scenarios_json.py
--rw-r--r--  2.0 unx      460 b- defN 23-Apr-01 23:42 dcontainer/devcontainer/feature_generation/file_models/test_sh.py
--rw-r--r--  2.0 unx        0 b- defN 23-Apr-01 23:42 dcontainer/devcontainer/models/__init__.py
--rw-r--r--  2.0 unx     6366 b- defN 23-Apr-01 23:42 dcontainer/devcontainer/models/devcontainer_feature.py
--rw-r--r--  2.0 unx     1534 b- defN 23-Apr-01 23:42 dcontainer/devcontainer/models/devcontainer_feature_definition.py
--rw-r--r--  2.0 unx        0 b- defN 23-Apr-01 23:42 dcontainer/utils/__init__.py
--rw-r--r--  2.0 unx      627 b- defN 23-Apr-01 23:42 dcontainer/utils/settings.py
--rw-r--r--  2.0 unx     1387 b- defN 23-Apr-01 23:42 dcontainer/utils/version.py
--rw-r--r--  2.0 unx     3452 b- defN 23-Apr-01 23:42 dcontainer-1.0.5.dist-info/METADATA
--rw-r--r--  2.0 unx       92 b- defN 23-Apr-01 23:42 dcontainer-1.0.5.dist-info/WHEEL
--rw-r--r--  2.0 unx       56 b- defN 23-Apr-01 23:42 dcontainer-1.0.5.dist-info/entry_points.txt
--rw-r--r--  2.0 unx       11 b- defN 23-Apr-01 23:42 dcontainer-1.0.5.dist-info/top_level.txt
--rw-rw-r--  2.0 unx     2824 b- defN 23-Apr-01 23:42 dcontainer-1.0.5.dist-info/RECORD
-28 files, 32069 bytes uncompressed, 11216 bytes compressed:  65.0%
...
@@ -39,14 +39,17 @@
 ...
 Filename: dcontainer/devcontainer/feature_generation/file_models/install_sh.py
 Comment: 
 
 Filename: dcontainer/devcontainer/feature_generation/file_models/library_scripts_sh.py
 Comment: 
 
+Filename: dcontainer/devcontainer/feature_generation/file_models/readme_md.py
+Comment: 
+
 Filename: dcontainer/devcontainer/feature_generation/file_models/scenarios_json.py
 Comment: 
 
 Filename: dcontainer/devcontainer/feature_generation/file_models/test_sh.py
 Comment: 
 
 Filename: dcontainer/devcontainer/models/__init__.py
@@ -63,23 +66,23 @@
...
-Filename: dcontainer-1.0.5.dist-info/METADATA
+Filename: dcontainer-1.0.6.dist-info/METADATA
 Comment: 
 
-Filename: dcontainer-1.0.5.dist-info/WHEEL
+Filename: dcontainer-1.0.6.dist-info/WHEEL
 Comment: 
 
-Filename: dcontainer-1.0.5.dist-info/entry_points.txt
+Filename: dcontainer-1.0.6.dist-info/entry_points.txt
 Comment: 
 
-Filename: dcontainer-1.0.5.dist-info/top_level.txt
+Filename: dcontainer-1.0.6.dist-info/top_level.txt
 Comment: 
 
-Filename: dcontainer-1.0.5.dist-info/RECORD
...
## Comparing `dcontainer-1.0.5.dist-info/METADATA` & `dcontainer-1.0.6.dist-info/METADATA`
...
## Comparing `dcontainer-1.0.5.dist-info/RECORD` & `dcontainer-1.0.6.dist-info/RECORD`
...
-dcontainer/devcontainer/feature_generation/dir_models/src_dir.py,sha256=BaigBTpaXjbM5VDKNg6Co_Bs4co6UZX6MOufRoR_cnQ,1303
...
-dcontainer-1.0.5.dist-info/METADATA,sha256=R1fu3RpqKRDv8etAk2basjuI2a1nVb9uooyI2SS_U6s,3452
-dcontainer-1.0.5.dist-info/WHEEL,sha256=pkctZYzUS4AYVn6dJ-7367OJZivF2e8RA9b_ZBjif18,92
-dcontainer-1.0.5.dist-info/entry_points.txt,sha256=Ir9OUF6kqae1fYrXQGg31EwpvqV3QmD_4FMfgMsYRoY,56
-dcontainer-1.0.5.dist-info/top_level.txt,sha256=_gvPjGYhxRs0y_Cw3IO-Kv0fjKgreD_rmmHCKXR_rm4,11
-dcontainer-1.0.5.dist-info/RECORD,,
